...
CONTAINERNAME = "tem-db-tables"

LOCALFILENAME = "ssp_table.csv"
BLOBNAME = "ssp_table.csv"

LOCALFILENAME_2 = "tradebook.csv"
BLOBNAME_2 = "tradebook.csv"

# initialize data - reading from blob storage
blob_service = BlockBlobService(account_name=STORAGEACCOUNTNAME, account_key=STORAGEACCOUNTKEY)
blob_service.get_blob_to_path(CONTAINERNAME, BLOBNAME, LOCALFILENAME)

blob_service_2 = BlockBlobService(account_name=STORAGEACCOUNTNAME, account_key=STORAGEACCOUNTKEY)
blob_service_2.get_blob_to_path(CONTAINERNAME, BLOBNAME_2, LOCALFILENAME_2)

dataframe_ssp = pd.read_csv(LOCALFILENAME)
dataframe_tradebook = pd.read_csv(LOCALFILENAME_2)
