...
def class_name_pretty(cls: Union[Type, GenericProxy, ModelClass, ModelSchema], *, class_name_func: Converter = class_name, class_name_from_path_func: Converter = class_name_from_path) -> str:
