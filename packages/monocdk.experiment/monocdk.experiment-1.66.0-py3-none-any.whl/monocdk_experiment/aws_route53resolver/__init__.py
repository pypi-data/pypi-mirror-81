...
class CfnResolverEndpoint(
    ...
    def ip_addresses(
        self,
        value: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnResolverEndpoint.IpAddressRequestProperty", _IResolvable_9ceae33e]]],
    ) -> None:
...
class CfnResolverQueryLoggingConfig(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverQueryLoggingConfig",
):
...
class CfnResolverQueryLoggingConfigAssociation(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverQueryLoggingConfigAssociation",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverQueryLoggingConfigAssociationProps",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverQueryLoggingConfigProps",
    jsii_struct_bases=[],
...
class CfnResolverRule(
    ...
    def target_ips(
        self,
        value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnResolverRule.TargetAddressProperty", _IResolvable_9ceae33e]]]],
    ) -> None:
