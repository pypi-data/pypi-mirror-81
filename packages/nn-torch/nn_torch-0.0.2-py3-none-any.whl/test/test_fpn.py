...
from nn_torch.cv.detection.fpnbody import ResNet34FPNBody, MobileNetV3LargeFPNBody
from nn_torch.cv.detection.resnet import ResNet34
...
def test_fpn():
    ...
    fpns: List[FPN] = [FPN(ResNet34FPNBody(ResNet34()), features_num=3, out_channels=out_channels),
                       FPN(MobileNetV3LargeFPNBody(MobileNetV3Large()), features_num=3, out_channels=out_channels)]
