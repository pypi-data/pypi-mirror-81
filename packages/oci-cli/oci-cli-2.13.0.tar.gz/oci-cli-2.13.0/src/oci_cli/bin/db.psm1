...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        'db' = 'autonomous-container-database autonomous-data-warehouse autonomous-data-warehouse-backup autonomous-database autonomous-database-backup autonomous-database-wallet autonomous-db-preview-version autonomous-db-version autonomous-exadata-infrastructure autonomous-exadata-infrastructure-shape autonomous-patch autonomous-vm-cluster backup backup-destination cloud-exa-infra cloud-vm-cluster console-connection data-guard-association database database-software-image db-home exadata-infrastructure external-backup-job gi-version maintenance-run node patch patch-history system system-shape version vm-cluster vm-cluster-network'
        ...
        'db autonomous-database' = 'change-compartment create create-from-backup-id create-from-backup-timestamp create-from-clone create-refreshable-clone data-safe delete fail-over generate-wallet get list list-clones manual-refresh restart restore rotate-key start stop switchover update'
