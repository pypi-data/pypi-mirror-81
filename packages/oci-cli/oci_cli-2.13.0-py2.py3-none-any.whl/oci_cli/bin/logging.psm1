...
function GetOciCommandsToLongParams_logging() {
    $ociCommandsToLongParams = @{
        ...
        'logging log-saved-search create' = 'compartment-id defined-tags description freeform-tags from-json help is-quick-start log-query name'
        'logging log-saved-search delete' = 'force from-json help if-match log-saved-search-id'
        ...
        'logging log-saved-search update' = 'defined-tags description force freeform-tags from-json help if-match is-quick-start log-query log-saved-search-id name'
