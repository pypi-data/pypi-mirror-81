...
from ..input.edit_location_type import EditLocationTypeInput
...
@dataclass
class EditLocationTypeMutation(DataClassJsonMixin):
    @dataclass
    ...
    data: EditLocationTypeMutationData

    @classmethod
    # fmt: off
    def execute(cls, client: GraphqlClient, input: EditLocationTypeInput) -> EditLocationTypeMutationData.LocationType:
        # fmt: off
        ...
        try:
            ...
            client.reporter.log_successful_operation("EditLocationTypeMutation", variables, network_time, decode_time)
