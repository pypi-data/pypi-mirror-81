...
class PulpAnsibleGalaxyApiCollectionsApi(object):
    ...
    def update(self, name, namespace, path, collection, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Update a Collection object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(name, namespace, path, collection, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(name, namespace, path, collection, **kwargs)  # noqa: E501

    def update_with_http_info(self, name, namespace, path, collection, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Update a Collection object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(name, namespace, path, collection, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('collection' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `collection` when calling `update`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/collections/{namespace}/{name}/', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
