...
_EVENTLABEL_LABEL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\360\320\207\353\004\001\362\276\300\244\007$extension.exists() != value.exists()', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_EVENTLABEL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\362\276\300\244\007$extension.exists() != value.exists()', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
