...
class Comment(object):
	...
	def set_commented_time(self, commented_time):
		...
		if commented_time is not None and not isinstance(commented_time, datetime.datetime):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: commented_time EXPECTED TYPE: datetime.datetime', None, None)
