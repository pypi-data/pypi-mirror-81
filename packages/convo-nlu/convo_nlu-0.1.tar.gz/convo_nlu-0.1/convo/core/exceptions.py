...
from convo.exceptions import ConvoException
...
class StoryParseError(ConvoCoreException, ValueError):
...
class UnsupportedDialogueModelError(ConvoCoreException):
...
class AgentNotReady(ConvoCoreException):
