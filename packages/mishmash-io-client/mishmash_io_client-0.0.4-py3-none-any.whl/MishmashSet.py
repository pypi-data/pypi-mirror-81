...
class MishmashSet():
    # TODO refacotr set using copy / deep copy think for other alternative because deepcopy is very slow
    # TODO magic methods?
    # TODO should we have index setting or we Can't set item in mishmashset directly
    # TODO __str repr representations ?
