...
test_requirements = requirements + [
    ...
    "sphinx", "sphinx-argparse", "nose", 'nose2', "nose-htmloutput", "rednose", "enpt"]
...
if not util.find_spec('pygrib'):
    warnings.warn('You need to install pygrib manually (use pip or conda install pygrib) if you want to download ECMWF'
                  'data in grib file format.')
