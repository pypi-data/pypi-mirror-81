...
class CfnSkill(
    ...
    def authentication_configuration(
        self,
        value: typing.Union["CfnSkill.AuthenticationConfigurationProperty", _IResolvable_9ceae33e],
    ) -> None:
    ...
    def skill_package(
        self,
        value: typing.Union["CfnSkill.SkillPackageProperty", _IResolvable_9ceae33e],
    ) -> None:
