...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, content_guard=None, repository=None, pulp_href=None, name=None, repository_version=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
