...
def validate_dataset(dataset_dir, ignore_errors=[]):
    ...
    if (error_code not in ignore_errors and "code" in dataset_json and
        set(dataset_json["dimensions_codes_order"]) != set(dataset_json["dimensions_labels"].keys())):
        errors.append({
            "error_code": error_code,
    ...
    if (error_code not in ignore_errors and "code" in dataset_json
        and set(dataset_json["dimensions_codes_order"]) != set(dataset_json["dimensions_values_labels"].keys())):
        errors.append({
            "error_code": error_code,
