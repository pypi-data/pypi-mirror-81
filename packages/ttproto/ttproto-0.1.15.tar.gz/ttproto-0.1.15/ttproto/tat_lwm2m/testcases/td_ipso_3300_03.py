...
class TD_IPSO_3300_03(CoAPTestCase):
    """
---
testcase_id: TD_IPSO_3300_03
uri: http://openmobilealliance.org/iot/lightweight-m2m-lwm2m
configuration: LWM2M_CFG_01
objective: 
  - Setting the writable resources of object 3300 (IPSO Generic Sensor) Instance 0 using JSON data format (11543)
  - This test has to be run for the following resource
  - - Application Type
pre_conditions: 
...
sequence:
  - step_id: 'TD_IPSO_3300_03_step_01'
    type: stimuli
    node: lwm2m_server
    description:
  ...
  - step_id: 'TD_IPSO_3300_03_step_02'
    type: check
    description:
      - 'Sent PUT request contains'
      - - Type=0 and Code=3
        - Non-empty payload = new value of Application Type
        - content-format=application/vnd.oma.lwm2m+json
        - URI-Path option= 3300/0

  - step_id: 'TD_IPSO_3300_03_step_03'
    type: check
    description:
  ...
  - step_id: 'TD_IPSO_3300_03_step_04'
    type: verify
    node: lwm2m_server
    description:
    ...
    def run(self):
        ...
        self.match('server', CoAP(type='con', code='put', opt=self.uri('/3300/0')), 'fail')
