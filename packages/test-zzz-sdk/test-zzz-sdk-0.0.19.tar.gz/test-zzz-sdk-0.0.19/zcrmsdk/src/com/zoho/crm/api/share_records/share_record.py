...
class ShareRecord(object):
	...
	def set_shared_time(self, shared_time):
		...
		if shared_time is not None and not isinstance(shared_time, datetime.datetime):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: shared_time EXPECTED TYPE: datetime.datetime', None, None)
