...
_MAX_USABLE_CPU_COUNT = multiprocessing.cpu_count() * 0.95
...
def _num_threads(num_bytes: int) -> int:
    ...
    return max(1, math.floor(min(_CPU_COUNT_SCALER, num_bytes ** _INVERSE_PI) * _MAX_USABLE_CPU_COUNT / _CPU_COUNT_SCALER))
