...
from anyscale.cluster_config import get_cluster_config, configure_for_session
...
def setup_aws_cross_account_role(
    email: str, region: str, user_id: str, name: str
) -> None:
...
def anyscale_exec(
    ...
    with tempfile.NamedTemporaryFile(mode="w") as config_file:
        ...
        proc = subprocess.check_call(command_lst)
