...
class Ui_EditorGeneralPage(object):
    def setupUi(self, EditorGeneralPage):
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.sourceOutlineGroupBox)
        ...
        self.horizontalLayout_2.addWidget(self.sourceOutlineWidthSpinBox)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(535, 101, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        EditorGeneralPage.setTabOrder(self.sourceOutlineWidthSpinBox, self.comment0CheckBox)
