...
from ..aws_sns import (
    ITopic as _ITopic_ef0ebe0e, SubscriptionFilter as _SubscriptionFilter_91537200
)
from ..aws_sns_subscriptions import (
    LambdaSubscriptionProps as _LambdaSubscriptionProps_923b2648
)
...
class ApiEventSource(
    ...
    def __init__(
        ...
        *,
        ...
        request_models: typing.Optional[typing.Mapping[builtins.str, _IModel_13fecd8f]] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_lambda_event_sources.SnsEventSourceProps",
    jsii_struct_bases=[_LambdaSubscriptionProps_923b2648],
    name_mapping={
        "dead_letter_queue": "deadLetterQueue",
        "filter_policy": "filterPolicy",
    },
)
class SnsEventSourceProps(_LambdaSubscriptionProps_923b2648):
    def __init__(
        self,
        *,
        dead_letter_queue: typing.Optional[_IQueue_b743f559] = None,
