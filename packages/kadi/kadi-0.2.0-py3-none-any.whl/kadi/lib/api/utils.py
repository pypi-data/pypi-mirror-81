        ...
        .. code-block:: python3

            {
                "<field>": {
                    ...
                    "required": True,
                    # Flag indicating wether multiple values for the same key can be
...
def reqschema(schema, description="", bind=True):
    ...
    :param description: (optional) Additional description of the request body. Supports
        reST syntax.
    :param bind: (optional) Flag indicating wether the schema should also be injected
...
def status(status_code, description):
    ...
    :param description: The description corresponding to the status code, describing
        when the status code occurs or wether there is a response body. Supports reST
        syntax.
    """
