...
class ArgusAPISession:
    ...
    def __init__(self):
        ...
        self.default_timeout = settings.get("api", {}).get(
            "timeout", int(os.getenv(self.TIMEOUT_ENV_VAR, self.DEFAULT_TIMEOUT))
        )
    ...
    def _request(self, method, _route, *args, **kwargs) -> Response:
        ...
        if kwargs.get("apiKey"):
            ...
            timeout = api_settings.get("timeout", self.default_timeout)
