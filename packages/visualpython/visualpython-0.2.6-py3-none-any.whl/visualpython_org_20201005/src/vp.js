(
    ...
    var saveVpPosition = function () {
        ...
        var newValues = vpWrapper.hasClass('sidebar-wrapper') ? ['width'] : ['right', 'top', 'height', 'width'];
    ...
    var createVpDiv = function (cfg, st) {
        ...
        $(document).on("mouseover", vpCommon.wrapSelector("#vp_header"), function() {
            vpWrapper.draggable( "enable" );
        });
        $(document).on("mouseout", vpCommon.wrapSelector("#vp_header"), function() {
            vpWrapper.draggable( "disable" );
        });
    };
    ...
    var loadVpResource = function (cfg, st) {
        ...
        vpCommon.loadCss(Jupyter.notebook.base_url + vpConst.BASE_PATH + vpConst.STYLE_PATH + vpConst.VP_CONTAINER_CSS_URL);
        ...
        $(vpCommon.wrapSelector("#vp_header", ">", ".header")).text(cfg.title_sidebar + ' ');
    };
