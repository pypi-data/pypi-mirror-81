...
_BLOCK_HORIZONTAL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='unused', full_name='Block.Horizontal.unused', index=0,
