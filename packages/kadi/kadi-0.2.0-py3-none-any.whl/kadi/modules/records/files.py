...
def remove_files(files, delete_from_db=True):
    ...
    :param delete_from_db: (optional) A flag indicating wether the file should be
...
def download_file(file):
    ...
    :return: The response object or ``None`` if the given file has an incompatible
        storage type.
    """
...
def get_preview_type(file, use_fallback=True):
    ...
    :param use_fallback: (optional) Flag indicating wether the file should be checked
