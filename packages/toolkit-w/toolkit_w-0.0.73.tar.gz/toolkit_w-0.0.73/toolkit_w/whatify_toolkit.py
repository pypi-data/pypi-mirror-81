...
class MyWhatify:
    ...
    @classmethod
    def get_data_file_s3(cls, file_name: str):
        logging.info("Deprecated func: get_data_file_s3, please use read_to_pandas_df function")
        return cls.read_to_pandas_df(file_name=file_name)
