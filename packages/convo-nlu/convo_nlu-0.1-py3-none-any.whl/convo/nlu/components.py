...
from convo.constants import DOCS_URL_MIGRATION_GUIDE
from convo.nlu.constants import TRAINABLE_EXTRACTORS
from convo.nlu.config import ConvoNLUModelConfig, override_defaults, InvalidConfigError
from convo.nlu.training_data import Message, TrainingData
...
def validate_empty_pipeline(pipeline: List["Component"]) -> None:
    ...
    Args:
        pipeline: the list of the :class:`convo.nlu.components.Component`.
    """
...
def _check_deprecated_attributes(component: "Component") -> None:
    ...
    Args:
        component: The :class:`convo.nlu.components.Component`.
    """
...
def any_components_in_pipeline(components: Iterable[Text], pipeline: List["Component"]):
    ...
    Args:
        components: A list of :class:`convo.nlu.components.Component`s to check.
        pipeline: A list of :class:`convo.nlu.components.Component`s.
...
def validate_required_components_from_data(
    ...
    Args:
        pipeline: The list of the :class:`convo.nlu.components.Component`s.
        data: The :class:`convo.nlu.training_data.training_data.TrainingData`.
    """
...
class Component(metaclass=ComponentMetaclass):
    ...
    def load(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            model_metadata: The model's :class:`convo.nlu.model.Metadata`.
    ...
    @classmethod
    def create(
        cls, component_config: Dict[Text, Any], config: ConvoNLUModelConfig
    ) -> "Component":
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        by a call to :meth:`convo.nlu.components.Component.create`
        of ANY component and
        on any context attributes created by a call to
        :meth:`convo.nlu.components.Component.train`
        of components previous to this one.

        Args:
            training_data:
                The :class:`convo.nlu.training_data.training_data.TrainingData`.
            config: The model configuration parameters.
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        of ANY component and
        on any context attributes created by a call to
        :meth:`convo.nlu.components.Component.process`
        of components previous to this one.

        Args:
            message: The :class:`convo.nlu.training_data.message.Message` to process.
    ...
    def cache_key(
        ...
        Args:
            ...
            model_metadata: The component's :class:`convo.nlu.model.Metadata`.
    ...
    def partially_process(self, message: Message) -> Message:
        ...
        Returns:
            The processed :class:`convo.nlu.training_data.message.Message`.
...
class ComponentBuilder:
    ...
    def load_component(
        ...
        **context: Any,
        ...
        Args:
            ...
            model_metadata (Metadata):
                The model's :class:`convo.nlu.model.Metadata`.
    ...
    def create_component(
        self, component_config: Dict[Text, Any], cfg: ConvoNLUModelConfig
    ) -> Component:
        """Creates a component.
