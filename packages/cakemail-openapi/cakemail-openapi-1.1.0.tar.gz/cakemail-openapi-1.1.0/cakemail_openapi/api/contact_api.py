...
class ContactApi(object):
    ...
    def list_contacts_of_segment(self, list_id, segment_id, **kwargs):  # noqa: E501
        ...
        :param int per_page:
        :param bool with_count:
        :param str query: Additional SQL selection query (only use one of query, fiql and json)
        :param str fiql: Additional FIQL selection expression (only use one of query, fiql and json)
        :param str json: Additional JSON selection expression (only use one of query, fiql and json)
        :param str sort: Sort term and direction, using syntax `[-|+]term`.  Valid terms:   - `name`   - `email`   - `created_on`   - `scheduled_for`   - `scheduled_on`   - `type`
        :param str filter: Valid Terms:   - `status`   - `email`  Valid Operators:   - `==`  Query separator:   - `;`
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
