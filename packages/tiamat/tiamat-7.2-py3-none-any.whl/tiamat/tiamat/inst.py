...
def mk_spec(hub, bname: str):
    ...
    # Freeze the packages that will be packaged into the binary and include the list in a predictable location
    # To use this file, your bundled app needs to read `os.path.join(sys._MEIPASS, "app_freeze.txt")`
