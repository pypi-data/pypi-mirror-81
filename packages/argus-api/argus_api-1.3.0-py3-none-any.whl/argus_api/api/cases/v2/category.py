...
def create_category(
    ...
    :param str domain: Name or ID of domain to create this category in. :param json:
...
def delete_category(
    ...
    :param str id: ID or shortname of category to delete:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_category(
    ...
    :param str id: ID or shortname of category to fetch:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_category(
    ...
    :param bool deprecated: If set, enable/disable the deprecated flag for this category. Default is no change. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
