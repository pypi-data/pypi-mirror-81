...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.24.0-alpha.1601645792+7a49ac99'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.24.0-alpha.1601645792+7a49ac99`
                """)
            else:
                raise
