...
[boto3.RedshiftDataAPIService 1.15.16](https://boto3.amazonaws.com/v1/documentation/api/1.15.16/reference/services/redshift-data.html#RedshiftDataAPIService) service
compatible with
