...
def NNCNN4(linear_feature_columns, dnn_feature_columns, 
         conv_kernel_width=(5, 5, 3), conv_filters=(64, 64, 64), mlp_ch_filters=(64, 64, 64), mlp_feat_filters=(22, 22, 22), pooling_width=(3, 3),
    ...
    for i in range(1, l + 1):
        ...
        nin_result = tf.keras.layers.Conv2D(filters=c_filters, kernel_size=(1, 1), strides=(1, 1), padding='same',
        ...
        nin_result = tf.keras.layers.Conv2D(filters=f_filters, kernel_size=(1, 1), strides=(1, 1), padding='same',
        ...
        if i < l:
            ...
            pooling_result = tf.transpose(pooling_result, [0, 3, 2, 1])
