...
class TD_IPSO_3304_03(CoAPTestCase):
    """
testcase_id: TD_IPSO_3304_03 
uri : http://openmobilealliance.org/iot/lightweight-m2m-lwm2m 
configuration: LWM2M_CFG_01 
objective: Delete an Instance of Humidity Sensor Object
pre_conditions:
...
sequence:
  - step_id: 'TD_IPSO_3304_03_step_01'
    type: stimuli
    node: lwm2m_server
    description:
      - 'LwM2M server sends a DELETE request (CoAP Delete) on Humidity Sensor object instance'
      - - Type = 0 (CON)
        - Code = 4 (DELETE)

  - step_id: 'TD_IPSO_3304_03_step_02'
    type: check
    description:
      - 'Sent DELETE request contains'
      - - Type=0 and Code=4
        - empty payload
        - URI-Path option= Location of the Humidity Sensor object instance. 

  - step_id: 'TD_IPSO_3304_03_step_03'
    type: check
    description:
  ...
  - step_id: 'TD_IPSO_3304_03_step_04'
    type: verify
    node: lwm2m_server
    description:
