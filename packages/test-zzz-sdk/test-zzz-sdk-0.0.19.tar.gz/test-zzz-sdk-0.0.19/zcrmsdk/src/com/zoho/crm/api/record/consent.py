...
class Consent(Record):
	...
	def set_mail_sent_time(self, mail_sent_time):
		...
		if mail_sent_time is not None and not isinstance(mail_sent_time, datetime.datetime):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: mail_sent_time EXPECTED TYPE: datetime.datetime', None, None)
