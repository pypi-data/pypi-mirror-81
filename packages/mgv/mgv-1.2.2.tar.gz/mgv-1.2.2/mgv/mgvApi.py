...
class MgvProject(object):
    ...
    def refreshHead(self):
        self.script = mgvWrapper.getNodeAttr(self, "script")
...
class MgvNodeVersion(object):
    ...
    def getVars(self):
        ...
        self.dico["MGVNODETYPEVERSION"] = str(self.typeForceVersion if self.typeForceVersion > -1 else (
            self.node.type.versionActive.id if self.node.type else -1))
