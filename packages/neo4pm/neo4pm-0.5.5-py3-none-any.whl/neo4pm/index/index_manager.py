...
class index_manager:
    ...
    def get_index_list(self):
        cypher_query = " CALL db.indexes "
        if self.connection_manager.version.startswith('3'):
            cypher_query += " YIELD tokenNames as index_node, properties as index_attributes "
        elif self.connection_manager.version.startswith('4'):
            cypher_query += " YIELD labelsOrTypes as index_node, properties as index_attributes "
        else:
