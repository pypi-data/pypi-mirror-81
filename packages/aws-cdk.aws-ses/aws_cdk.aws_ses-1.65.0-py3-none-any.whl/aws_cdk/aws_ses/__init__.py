...
class CfnConfigurationSetEventDestination(
    ...
    def event_destination(
        self,
        value: typing.Union[aws_cdk.core.IResolvable, "EventDestinationProperty"],
    ) -> None:
...
class CfnReceiptFilter(
    ...
    def filter(
        self,
        value: typing.Union["FilterProperty", aws_cdk.core.IResolvable],
    ) -> None:
...
class CfnReceiptRule(
    ...
    def rule(
        self,
        value: typing.Union[aws_cdk.core.IResolvable, "RuleProperty"],
    ) -> None:
