...
from convo.core.events import ActionExecuted, Event
from convo.core.featurizers import MaxHistoryTrackerFeaturizer
from convo.nlu.constants import INTENT
from convo.core.training.generator import TrackerWithCachedStates
    ...
    def _summarize_conflicting_actions(action: Text, stories: List[Text]) -> Text:
        ...
        if len(stories) > 3:
            ...
            raise ValueError(
                ...
                "Please file a bug report at https://github.com/ConvoHQ/convo."
            )
