define ([    
    ...
    var renderParamTitle = function(tabDataObj) {
        ...
        var numpyBlock = $(`<div class="vp-numpy-option-block vp-spread" id="vp_blockArea"></div`);
    ...
    var renderParamTabButtonBlock = function( numpyBlock, tabDataObj, uuid) {
        var buttonContainer = $(`<div class="vp-numpy-tab vp-numpy-style-flex-row" id="vp_numpyTab"></div>`);
    ...
    var renderParamTabViewBlock = function(numpyBlock, tabDataObj, uuid) {
        ...
        for(var i = 0; i < tabBlockArray.length; i++) {
            (function(j) {
                const { btnText } = tabBlockArray[j];
                var viewDom = $(`<div class="vp-numpy-tab-block-element-${uuid}-${j+1} vp-numpy-tab-block-element-${uuid}" id="vp_numpyTabBlock">
                                        <h4>
