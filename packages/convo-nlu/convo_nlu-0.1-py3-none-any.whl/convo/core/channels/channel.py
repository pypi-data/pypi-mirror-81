...
class InputChannel:
    ...
    def get_output_channel(self) -> Optional["OutputChannel"]:
        ...
        ``OutputChannel`` this can be used by Convo to send bot responses to the user
...
class RestInput(InputChannel):
    ...
    frontend. You can customize this to send messages to Convo Core and
    ...
    def blueprint(
        ...
        async def receive(request: Request) -> HTTPResponse:
            ...
            should_use_stream = convo.utils.endpoints.bool_arg(
