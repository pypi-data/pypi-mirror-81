...
__DATA_TYPES = {'Location': Location, 'User': User}
__EXTRA_FIELD = '_d_type'
...
def decode_data(data: bytes):
    obj = loads(data)
    d_type = obj[__EXTRA_FIELD]
    del obj[__EXTRA_FIELD]

    if d_type in __DATA_TYPES:
        return (d_type, __DATA_TYPES[d_type](**obj))
