...
def bind_category(
    ...
    :param list caseTypes: Case types to bind category for :param json:
...
def create_service(
    ...
    :param str fieldPolicy: The ID of a field policy to set for this service. Default is no policy. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_service(
    ...
    :param str id: ID or shortname of service to delete:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_field_policy_by_service(
    ...
    :param str domain: Domain to lookup service and customer in (when using shortnames). Defaults to the current users domain.:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_service(
    ...
    :param str id: ID or shortname of service:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def unbind_category(
    ...
    :param list caseType: Casetypes to unbind (default is all):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_service(
    ...
    :param bool deprecated: If set, enable/disable the deprecated flag for this service. Default is no change. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
