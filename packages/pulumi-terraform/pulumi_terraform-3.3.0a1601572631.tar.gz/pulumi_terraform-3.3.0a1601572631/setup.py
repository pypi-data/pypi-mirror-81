...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '3.3.0-alpha.1601572631+f915a3dd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 3.3.0-alpha.1601572631+f915a3dd`
                """)
