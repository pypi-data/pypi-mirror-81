...
def add_comment_1(
    ...
    :param int id: ID of instance to comment:param json:
...
def delete_2(
    ...
    :param int id: ID of instance to delete:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def disable_monitoring_1(
    ...
    :param int id: ID of instance to disable monitoring on:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def enable_monitoring_1(
    ...
    :param int id: ID of instance to enable monitoring on:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def list_3(
    ...
    :param int limit: Limit results:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def schedule_monitoring_1(
    ...
    :param int id: ID of instance to schedule downtime for:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search_3(
    ...
    :param bool inDowntime: If true, only return instances which are in scheduled downtime, or whose host is in downtime. If false, exclude. If not set, do not filter. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_2(
    ...
    :param str codeProfile: Name of code profile to use. If null, do not change. If blank, reset to template profile.  => [a-zA-Z0-9_\-\.]*:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def view_1(
    ...
    :param int id: ID of instance to fetch:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
