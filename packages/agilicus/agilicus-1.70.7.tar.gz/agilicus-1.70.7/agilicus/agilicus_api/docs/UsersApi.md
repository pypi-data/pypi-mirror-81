...
------------- | ------------- | -------------
[**bulk_update_metadata**](UsersApi.md#bulk_update_metadata) | **PUT** /v1/user_metadata | Update a group of user&#39;s metadata for the specified org
...
|-------------|-------------|------------------|
**204** | Return user metadata entries |  -  |
