...
class Canary(
    ...
    def __init__(
        ...
        *,
        ...
        :param runtime: Specify the runtime version to use for the canary. Default: Runtime.SYNTHETICS_NODEJS_2_0
...
class Runtime(
    ...
    def SYNTHETICS_NODEJS_2_0(cls) -> "Runtime":
        """``syn-nodejs-2.0`` includes the following: - Lambda runtime Node.js 10.x - Puppeteer-core version 3.3.0 - Chromium version 81.0.4044.0.
