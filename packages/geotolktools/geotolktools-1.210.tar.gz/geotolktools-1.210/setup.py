...
setup(
  ...
  version = '1.210',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/Fundator/geotolk-tools/archive/v.1.210.tar.gz',    # I explain this later on
