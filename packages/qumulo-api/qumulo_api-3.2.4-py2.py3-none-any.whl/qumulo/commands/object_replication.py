...
class CreateObjectRelationshipCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        ...
        parser.add_argument(
            ...
            required=True,
            help="""S3-compatible server address. For Amazon S3, use
        ...
        parser.add_argument(
            ...
            help="""Addressing style for requests to the bucket. Set to
                ...
                path-style is deprecated. The object-store-address should not
                include the bucket name, regardless of addressing style.""",
        )
        parser.add_argument(
