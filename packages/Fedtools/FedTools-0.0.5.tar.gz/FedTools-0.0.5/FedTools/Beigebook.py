...
class BeigeBooks(object):
  ...
  def __init__(self,
    ...
    if isinstance(historical_split, int) is False:
      raise TypeError(
        "The historical_split argument must be an integer object. Please refer to https://www.federalreserve.gov/monetarypolicy/beige-book-archive.htm for the start year")
