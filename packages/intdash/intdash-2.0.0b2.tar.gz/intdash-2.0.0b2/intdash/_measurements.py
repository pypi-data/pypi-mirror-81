...
class Measurements(object):
    ...
    def create(
        ...
        return intdash.Measurement._from_dict(resp)
    ...
    def get(self, uuid=None, marker_uuid=None):
        ...
        # measurement markers supported by intdash-api v1.10.0
        supported = intdash._utils._check_supported(self.client.api_version, "1.10.0")
        ...
        resp = json.loads(
            self.client._request(method="get", spath=path, supported=supported).text
        )
    ...
    def list(
        ...
        return [intdash.Measurement._from_dict(item) for item in resp["items"]]
    ...
    def _iter_lists(
        ...
        yield [intdash.Measurement._from_dict(item) for item in resp["items"]]
