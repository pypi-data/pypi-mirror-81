...
[boto3.MarketplaceMetering 1.15.16](https://boto3.amazonaws.com/v1/documentation/api/1.15.16/reference/services/meteringmarketplace.html#MarketplaceMetering) service
compatible with
