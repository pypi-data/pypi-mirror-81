...
def calculate_mi(rv_samples: Iterable[Iterable], target: Iterable, float_bins: int = 100) -> float:
    """
    Numpy-based implementation of mutual information for joint distribution of n random variables and a target variable.
    This can be used for both categorical (discrete) and continuous variables, you can as many as you want of each 
