class Resource:
    ...
    def __init__(self, params):
        self.rsrc_id = int(params[0].strip()) if params[0].strip() else None
        self.parent_rsrc_id = int(params[1].strip()) if params[1].strip() else None
        self.clndr_id = int(params[2].strip()) if params[2].strip() else None
        self.role_id = int(params[3].strip()) if params[3].strip() else None
