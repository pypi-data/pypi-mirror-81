...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.20.0-alpha.1601472153+a3512a9b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.20.0-alpha.1601472153+a3512a9b`
                """)
            else:
                raise
