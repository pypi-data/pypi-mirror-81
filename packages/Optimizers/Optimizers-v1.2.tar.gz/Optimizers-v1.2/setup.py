...
setup(
  ...
  description = 'A collection of examples for learning mathematical modelling',   # Give a short description about your library
  ...
  download_url = 'https://github.com/davidswlai/Optimizers/archive/v1.2.tar.gz',    # I explain this later on
  keywords = ['Optimizers', 'Mathematical Models', 'Logistics', 'Routing', 'Scheduling' ],   # Keywords that define your package best
