...
class Postgres(Construct):
    def __init__(self, scope: Construct, id: str, *, master_username: str, vpc: IVpc, database_name: str,
                 ...
                 version: PostgresEngineVersion = PostgresEngineVersion.VER_10_12,
        ...
        db_engine = DatabaseInstanceEngine.postgres(version)
        parameter_group = ParameterGroup(scope, 'rds-parameter-group', engine=db_engine, parameters=parameters)
        option_group = OptionGroup(scope, 'rds-option-group', engine=db_engine, configurations=[])
