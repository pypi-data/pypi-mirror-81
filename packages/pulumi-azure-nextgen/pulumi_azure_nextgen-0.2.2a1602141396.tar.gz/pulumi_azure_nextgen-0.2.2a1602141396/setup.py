...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure-nextgen', '0.2.2a1602141396'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure-nextgen 0.2.2a1602141396`
                """)
            else:
                raise
