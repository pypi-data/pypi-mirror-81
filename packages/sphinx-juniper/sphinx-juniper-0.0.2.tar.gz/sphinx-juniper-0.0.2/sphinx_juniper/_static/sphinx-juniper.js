...
$(document).ready( function() {
    ...
    $("<a class='dropdown-buttons' onclick='juniperInit()'><button type='button' class='btn btn-secondary topbarbtn' title=''data-toggle='tooltip' data-placement='left'data-original-title='Initialize Juniper'>&#x1F347 &nbsp Juniper</button></a>").appendTo(dropdown);
})
