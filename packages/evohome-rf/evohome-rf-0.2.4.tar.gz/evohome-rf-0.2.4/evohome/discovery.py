async def periodic(cmd, interval=10, count=999):
    for _ in range(count):
        await asyncio.sleep(interval)
        await manager.put_pkt(cmd, _LOGGER)


_ = asyncio.create_task(periodic(Command("RQ", "13:237335", "0008", "00")))
_ = asyncio.create_task(periodic(Command("RQ", "13:237335", "3EF1", "00"), interval=15))
