...
setup(
  name = 'bibyone',         # How you named your package folder (MyLib)
  packages = ['bibyone'],   # Chose the same as "name"
  ...
  url = 'https://github.com/Mahmoud7Osman/bibyone',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/Mahmoud7Osman/bibyone/archive/1.0.tar.gz',    # I explain this later on
