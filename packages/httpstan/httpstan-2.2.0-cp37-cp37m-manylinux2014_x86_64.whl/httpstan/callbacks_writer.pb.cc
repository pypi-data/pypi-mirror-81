...
bool WriterMessage_Topic_Parse(
    const std::string& name, WriterMessage_Topic* value) {
  int int_value;
...
WriterMessage_StringList::WriterMessage_StringList()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:stan.WriterMessage.StringList)
}
...
WriterMessage_DoubleList::WriterMessage_DoubleList()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:stan.WriterMessage.DoubleList)
}
...
WriterMessage_IntList::WriterMessage_IntList()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:stan.WriterMessage.IntList)
}
...
WriterMessage_Feature::WriterMessage_Feature()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:stan.WriterMessage.Feature)
}
...
WriterMessage::WriterMessage()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:stan.WriterMessage)
}
...
template<> PROTOBUF_NOINLINE ::stan::WriterMessage_StringList* Arena::CreateMaybeMessage< ::stan::WriterMessage_StringList >(Arena* arena) {
  return Arena::CreateInternal< ::stan::WriterMessage_StringList >(arena);
}
