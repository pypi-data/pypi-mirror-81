...
PART_PATTERNS = {'YYYY': '[1-9][0-9]{3}', 'YY': '[1-9][0-9]?', '0Y':
    ...
    'BLD': '[1-9][0-9]*', 'RELEASE': 'preview|final|alpha|beta|post|rc',
...
PATTERN_PART_FIELDS = {'YYYY': 'year_y', 'YY': 'year_y', '0Y': 'year_y',
    ...
    'bid', 'BLD': 'bid', 'RELEASE': 'tag', 'PYTAG': 'pytag', 'NUM': 'num',
...
PEP440_PART_SUBSTITUTIONS = {'0W': 'WW', '0U': 'UU', '0V': 'VV', '0M': 'MM',
    '0D': 'DD', '00J': 'JJJ', 'BUILD': 'BLD', 'RELEASE': 'PYTAG'}
...
PART_FORMATS = {'YYYY': _fmt_num, 'YY': _fmt_yy, '0Y': _fmt_0y, 'GGGG':
    ...
    'BUILD': _fmt_num, 'BLD': _fmt_bld, 'RELEASE': _fmt_num, 'PYTAG':
    _fmt_num, 'NUM': _fmt_num, 'INC0': _fmt_num, 'INC1': _fmt_num, 'WW':
    _fmt_num, '0W': _fmt_0w, 'UU': _fmt_num, '0U': _fmt_0u, 'VV': _fmt_num,
    '0V': _fmt_0v}


def convert_to_pep440(version_pattern):
...
def normalize_pattern(version_pattern, raw_pattern):
    ...
    if '{pep440_version}' in normalized_pattern:
        pep440_version_pattern = convert_to_pep440(version_pattern)
