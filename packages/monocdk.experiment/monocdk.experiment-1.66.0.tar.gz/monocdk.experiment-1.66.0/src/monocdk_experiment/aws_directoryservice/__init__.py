...
class CfnMicrosoftAD(
    ...
    def __init__(
        ...
        *,
        ...
        create_alias: typing.Optional[typing.Union[builtins.bool, _IResolvable_9ceae33e]] = None,
        edition: typing.Optional[builtins.str] = None,
        enable_sso: typing.Optional[typing.Union[builtins.bool, _IResolvable_9ceae33e]] = None,
    ...
    def vpc_settings(
        self,
        value: typing.Union["CfnMicrosoftAD.VpcSettingsProperty", _IResolvable_9ceae33e],
    ) -> None:
...
class CfnSimpleAD(
    ...
    def vpc_settings(
        self,
        value: typing.Union["CfnSimpleAD.VpcSettingsProperty", _IResolvable_9ceae33e],
    ) -> None:
        jsii.set(self, "vpcSettings", value)
