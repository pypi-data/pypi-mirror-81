...
class TD_M2M_NH_33(CoAPTestCase):
    """

TD_M2M_NH_33:
    cfg: M2M_CFG_01
    obj: AE updates attribute in group resource.
    pre: AE has created a <group> resource on registrar CSE.
    ref: 'TS-0001, clause 10.2.7.4; TS-0004, clause 7.3.12.2.3'
    seq:
    -   s:
    ...
    -   c:
        ...
        -   - Type=0 and Code=3
            ...
            - Non-Empty payload      
    -   v: Check if possible that the <group> resource is updated in Registrar CSE. 
    -   c:
