...
class NLUPipeline(BasePipe):
    ...
    def predict(self, data, output_level='', positions=False, keep_stranger_features=True, metadata=False, multithread=True):
        ...
        try:
            ...
            e = sys.exc_info()
            print("No accepted Data type or usable columns found or applying the NLU models failed. Does your Dataframe contain a column named text?")
            print('Full Stacktrace was',e)
            print('Full Stacktrace was',)
            ...
            # TODO SLACK URL
            print('Stuck? Contact us on Slack! <URL>')
            return None
