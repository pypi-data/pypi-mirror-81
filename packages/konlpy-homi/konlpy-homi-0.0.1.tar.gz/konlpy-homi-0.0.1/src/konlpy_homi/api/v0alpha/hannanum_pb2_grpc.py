...
class HannanumStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Pos = channel.unary_unary(
                '/konlpy_homi.api.v0alpha.Hannanum/Pos',
        ...
        self.Nouns = channel.unary_unary(
                '/konlpy_homi.api.v0alpha.Hannanum/Nouns',
                request_serializer=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.SerializeToString,
        ...
        self.Morphs = channel.unary_unary(
                '/konlpy_homi.api.v0alpha.Hannanum/Morphs',
                request_serializer=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.SerializeToString,
                response_deserializer=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringArrayResponse.FromString,
                )
        self.Analyze = channel.unary_unary(
                '/konlpy_homi.api.v0alpha.Hannanum/Analyze',
                request_serializer=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.SerializeToString,
                response_deserializer=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.TupleDoubleArrayResponse.FromString,
                )
...
def add_HannanumServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Analyze': grpc.unary_unary_rpc_method_handler(
                    servicer.Analyze,
                    request_deserializer=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.FromString,
                    response_serializer=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.TupleDoubleArrayResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'konlpy_homi.api.v0alpha.Hannanum', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class Hannanum(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Pos(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/konlpy_homi.api.v0alpha.Hannanum/Pos',
    ...
    def Nouns(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/konlpy_homi.api.v0alpha.Hannanum/Nouns',
            konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.SerializeToString,
    ...
    def Morphs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/konlpy_homi.api.v0alpha.Hannanum/Morphs',
            konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.SerializeToString,
            konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringArrayResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Analyze(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/konlpy_homi.api.v0alpha.Hannanum/Analyze',
            konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.SerializeToString,
            konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.TupleDoubleArrayResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
