...
from convo.core.training.dsl import UserUttered
from convo.core.training.dsl import ActionExecuted
from convo.core.constants import UTTER_PREFIX
import convo.core.training.story_conflict
from convo.constants import DOCS_URL_DOMAINS, DOCS_URL_ACTIONS
...
class Validator:
    ...
    def verify_story_structure(
        ...
        conflicts = convo.core.training.story_conflict.find_story_conflicts(
