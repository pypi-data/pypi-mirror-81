...
from convo.core.actions.action import ACTION_LISTEN_NAME
...
from convo.core.conversation import Dialogue
from convo.core.domain import Domain
from convo.core.events import SessionStarted
from convo.core.trackers import ActionExecuted, DialogueStateTracker, EventVerbosity
import convo.cli.utils as convo_cli_utils
from convo.utils.common import class_from_module_path, raise_warning, arguments_of
...
class TrackerStore:
    ...
    def create_tracker_store(
        ...
        raise_warning(
            ...
            "removed in future Convo versions.",
            DeprecationWarning,
        )
    ...
    def _deserialise_dialogue_from_pickle(
        ...
        logger.warning(
            ...
            f"trackers will be deprecated in version 2.0. Convo will perform any "
...
def _create_sequence(table_name: Text) -> "Sequence":
    ...
    as described here: https://convo.com/docs/convo/api/tracker-stores/#sqltrackerstore
    Args:
...
class SQLTrackerStore(TrackerStore):
    ...
    def session_scope(self):
        ...
        try:
            ...
            convo_cli_utils.print_error_and_exit(
