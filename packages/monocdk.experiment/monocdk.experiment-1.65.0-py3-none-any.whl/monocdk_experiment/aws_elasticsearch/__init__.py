...
class DomainProps:
    def __init__(
        ...
        *,
        ...
        :param vpc_options: The virtual private cloud (VPC) configuration for the Amazon ES domain. For more information, see `VPC Support for Amazon Elasticsearch Service Domains <https://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/es-vpc.html>`_ in the Amazon Elasticsearch Service Developer Guide. Default: - VPC not used
...
class EbsOptions:
    def __init__(
        ...
        *,
        ...
        :param volume_type: The EBS volume type to use with the Amazon ES domain, such as standard, gp2, io1, st1, or sc1. For more information, see[Configuring EBS-based Storage] (https://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/es-createupdatedomains.html#es-createdomain-configure-ebs) in the Amazon Elasticsearch Service Developer Guide. Default: gp2
...
class VpcOptions:
    def __init__(
        ...
        *,
        ...
        :param subnets: Provide one subnet for each Availability Zone that your domain uses. For example, you must specify three subnet IDs for a three Availability Zone domain. To learn more, see [VPCs and Subnets] (https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html) in the Amazon VPC User Guide.
