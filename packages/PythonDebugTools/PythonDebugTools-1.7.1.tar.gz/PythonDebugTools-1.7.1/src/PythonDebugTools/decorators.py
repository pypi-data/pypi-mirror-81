...
__all__ = ['Debug', 'ClassMethodDebug', 'CheckTime', 'DebugTkinterEvent', 'SimpleDebug', 'StackTrace', 'StackTraceWithSignature']
...
def CheckTime(func: callable, tag: str = DEFAULT_TAG):
    name = GetFunctionName(func)
