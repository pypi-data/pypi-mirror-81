...
setup(
  ...
  download_url = 'https://github.com/davidswlai/Optimizers/archive/v0.7-beta.tar.gz',    # I explain this later on
  keywords = ['Optimizers', 'Logistics', 'Routing', 'Scheduling'],   # Keywords that define your package best
