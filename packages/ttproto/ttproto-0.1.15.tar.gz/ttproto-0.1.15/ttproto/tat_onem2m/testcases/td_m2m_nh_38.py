...
TD_M2M_NH_38:
    ...
    ref: 'TS-0001, clause 10.2.14.4; TS-0004, clause 7.3.18.2.4'
    seq:
    -   s:
        - 'AE is requested to send node Delete Request:'
        -   - Type = 0 (CON)
            - Code = 4 (DELETE)
    -   c:
    ...
    -   c:
        ...
        -   - Code = 2.02 (OK)
            ...
            - oneM2M-RSC=2002
            - oneM2M-RQI=CRQI
    -   v: Check if possible that the <node> resource has been removed from registrar CSE
