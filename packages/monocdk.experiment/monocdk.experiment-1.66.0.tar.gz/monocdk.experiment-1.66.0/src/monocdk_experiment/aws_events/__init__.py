...
class CfnEventBusPolicy(
    ...
    def condition(
        self,
        value: typing.Optional[typing.Union["CfnEventBusPolicy.ConditionProperty", _IResolvable_9ceae33e]],
    ) -> None:
...
class CfnRule(
    ...
    def targets(
        self,
        value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnRule.TargetProperty", _IResolvable_9ceae33e]]]],
    ) -> None:
