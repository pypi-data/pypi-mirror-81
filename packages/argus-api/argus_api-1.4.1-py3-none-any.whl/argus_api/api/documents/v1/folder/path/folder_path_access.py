...
def add_document(
    ...
    :param bool inheritExplicitPermissions: Inherit explicit permissions from parent folder (default false):param json:
...
def add_document_raw(
    ...
    :param bool overwriteExisting: If true, overwrite existing document with the same name:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def add_folder_by_path(
    ...
    :param str name: Name of new folder  => Sanitize by regex \A[^\\\/:*"?<>|]{1,254}\z
    :param str accessMode: General access mode of new folder (default roleBased)
    :param bool createMissingFolders: If true, create any missing parent folder elements (default false):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def add_folder_watcher(
    ...
    :param bool negated: If true, register an explicitly negated watcher entry. Default is to add a new active watcher. (default false):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_folder(
    ...
    :param str mode: Recursive folder delete strategy, default is DELETE_IF_EMPTY:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_folder_watcher(
    ...
    :param int folderID: ID of folder
    :param str entryID: ID of watcher entry:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_folder_watcher_by_path(
    ...
    :param str customer: Customer space to lookup folder in (default is current users customer):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_current_user_folder_watch_status(
    ...
    :param int folderID: ID of folder:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_current_user_folder_watch_status_by_path(
    ...
    :param str path: Path to folder
    :param str customer: Customer space to fetch from (default is current users customer):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_folder_meta_info_by_id(
    ...
    :param int folderID: ID of folder to fetch:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def grant_folder_access(
    ...
    :param str level: Specify access level to grant to user/group :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def list_document_watchers_1(
    ...
    :param bool includeInherited: If true, also fetch watchers defined on parent folders:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def move_folder(
    ...
    :param int newFolderID: :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def revoke_folder_access(
    ...
    :param int folderID: Folder ID
    :param int accessID: Access ID:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def set_current_user_folder_watch_status(
    ...
    :param int folderID: ID of folder
    :param bool watch: If true, enable an explicit watcher for the current user for the target folder. If false, add an explicit negation for the current user. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_document_access_settings_1(
    ...
    :param int folderID: Folder ID
    :param str accessMode: Specify general access mode for document/folder :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_folder(
    ...
    :param int folderID: ID of folder to update
    :param str name: If set change folder name  => Sanitize by regex \A[^\\\/:*"?<>|]{1,254}\z:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
