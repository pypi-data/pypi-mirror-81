...
class directoryOrganiser:
    ...
    def move_To_Document(self):
        ...
        for document in self.documents:
            shutil.move(os.path.join(self.source, document), os.path.join(destination, document))
    ...
    def move_To_Pictures(self):
        ...
        for picture in self.pictures:
            shutil.move(os.path.join(self.source, picture), os.path.join(destination, picture))
    ...
    def move_To_Music(self):
        ...
        for music in self.musics:
            shutil.move(os.path.join(self.source, music), os.path.join(destination, music))
    ...
    def move_To_Videos(self):
        ...
        for video in self.videos:
            shutil.move(os.path.join(self.source, video), os.path.join(destination, video))
    ...
    def move_To_Others(self):
        ...
        for other in self.others:
            shutil.move(os.path.join(self.source, other), os.path.join(destination, other))
