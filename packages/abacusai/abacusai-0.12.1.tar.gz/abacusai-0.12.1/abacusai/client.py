...
class ApiClient():
    ...
    def create_deployment(self, model_id: str, name: str = None, description: str = None, deployment_config: dict = None, calls_per_second: int = None):
        '''Creates a deployment with the specified name and description for the specified model.    '''
        return self._call_api('createDeployment', 'POST', query_params={}, body={'modelId': model_id, 'name': name, 'description': description, 'deploymentConfig': deployment_config, 'callsPerSecond': calls_per_second}, parse_type=Deployment)
    ...
    def batch_prediction_from_upload(self, deployment_id: str, name: str = None, global_prediction_args: dict = None):
        ...
        return self._call_api('batchPredictionFromUpload', 'POST', query_params={'deploymentId': deployment_id}, body={'name': name, 'globalPredictionArgs': global_prediction_args}, parse_type=Upload)
