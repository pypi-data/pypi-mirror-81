...
from convo.core.channels.channel import CollectingOutputChannel, UserMessage
        ...
        if isinstance(event, UserUttered):
            ...
            for m in out.messages:
                ...
                if buttons is not None:
                    color = convo.cli.utils.bcolors.OKBLUE
                    convo.cli.utils.print_color("Buttons:", color=color)
                    for idx, button in enumerate(buttons):
                        convo.cli.utils.print_color(
...
def load_tracker_from_json(tracker_dump: Text, domain: Domain) -> DialogueStateTracker:
    ...
    tracker_json = json.loads(convo.utils.io.read_file(tracker_dump))
