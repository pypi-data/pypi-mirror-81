    ...
    for study in studies:
        for word in mouse_keywords:
            if (
                ...
                mouse.add(study['accession'] + " " + study['name'])
        for word in human_keywords:
            if (
                word.lower() in study['name'].lower()
                or word.lower() in study['description'].lower()
            ):
                human.add(study['accession'] + " " + study['name'])
        if (
            study['accession'] + " " + study['name'] in mouse
            and study['accession'] + " " + study['name'] in human
        ):
            mouse.remove(study['accession'] + " " + study['name'])
            human.remove(study['accession'] + " " + study['name'])
            both.add(study['accession'] + " " + study['name'])
