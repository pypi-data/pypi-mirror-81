...
*TagsApi* | [**add_tag**](docs/TagsApi.md#add_tag) | **POST** /tags/add/ | Adds an object to the tag name
*TagsApi* | [**create_tag**](docs/TagsApi.md#create_tag) | **POST** /tags/ | Creates a new tag for the user
*TagsApi* | [**delete_all_tags**](docs/TagsApi.md#delete_all_tags) | **POST** /tags/delete_all/ | Deletes all of the user&#39;s tags
*TagsApi* | [**delete_tag**](docs/TagsApi.md#delete_tag) | **POST** /tags/delete/ | Deletes a specific tag
*TagsApi* | [**empty_tag**](docs/TagsApi.md#empty_tag) | **POST** /tags/empty | Removes all objects from a tag
*TagsApi* | [**get_tag**](docs/TagsApi.md#get_tag) | **GET** /tags/{tag_name}/ | Retrieves a specific tag for a user
*TagsApi* | [**list_collection_tags**](docs/TagsApi.md#list_collection_tags) | **POST** /tags/collection/ | Returns all of the user&#39;s tags in a given collection
*TagsApi* | [**list_tags**](docs/TagsApi.md#list_tags) | **GET** /tags/ | Gets all the user&#39;s tags
*TagsApi* | [**merge_tag**](docs/TagsApi.md#merge_tag) | **POST** /tags/merge/ | Merges two tag collections into a single one
*TagsApi* | [**remove_tag**](docs/TagsApi.md#remove_tag) | **POST** /tags/remove/ | Removes an object from a tag collection
*TagsApi* | [**rename_tag**](docs/TagsApi.md#rename_tag) | **POST** /tags/rename/ | Renames a tag and it&#39;s collection
