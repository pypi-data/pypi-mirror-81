...
from unicon.plugins.generic.service_patterns import ReloadPatterns, SwitchoverPatterns
...
class IosXESwitchoverPatterns(SwitchoverPatterns):
    def __init__(self):
        super().__init__()
        self.switchover_username = r'^.*username.*(\[.*\])?.*$'
        self.switchover_password = r'^.*[Pp]assword.*(\[.*\])?.*$'