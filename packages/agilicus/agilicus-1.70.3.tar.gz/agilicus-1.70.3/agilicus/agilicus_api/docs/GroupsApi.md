...
# **list_groups**
> ListGroupsResponse list_groups(org_id=org_id, type=type)
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    api_instance = agilicus_api.GroupsApi(api_client)
    org_id = '1234' # str | Organisation Unique identifier (optional)
type = 'group' # str | group type (optional) (default to 'group')

    try:
        # Get all groups
        api_response = api_instance.list_groups(org_id=org_id, type=type)
        pprint(api_response)
    except ApiException as e:
...
------------- | ------------- | ------------- | -------------
 **org_id** | **str**| Organisation Unique identifier | [optional] 
 **type** | **str**| group type | [optional] [default to &#39;group&#39;]
