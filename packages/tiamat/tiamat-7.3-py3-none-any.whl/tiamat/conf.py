...
CONFIG = {
    ...
    "exclude": {
        "default": None,
        "help": "A list of exclude files or python modules, these python packages will be ignored by pyinstaller",
    },
    "system_site": {
        "default": False,
    ...
    "pyinstaller_version": {
        "default": "4.0",
        "help": "The version of Pyinstaller to install.  If 'dev' is specified it will be installed from git",
    },
    "pyinstaller_runtime_tmpdir": {
        "default": None,
    ...
    "pyinstaller_args": {
        "default": None,
        "help": "Args to pass straight through to pyinstaller. I.E. tiamat build --pyinstaller-args='--key=1234 -v'",
    },
