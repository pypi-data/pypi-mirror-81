...
def commit_document(
    ...
    :param int lockRequestTime: Specify how long the document should be locked (default 0):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_document(
    ...
    :param int documentID: ID of document to discard:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_current_user_document_watch_status(
    ...
    :param int documentID: ID of document:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_document_content_by_id(
    ...
    :param int documentID: ID of document to fetch:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def lock_document(
    ...
    :param str mode: Specify whether to lock or unlock the document, or to override an existing lock (default LOCK):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search_documents(
    ...
    :param bool recursive: Search all subfolders below selected folders (default true):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def set_current_user_document_watch_status(
    ...
    :param int documentID: ID of document
    :param bool watch: If true, enable an explicit watcher for the current user for the target document. If false, add an explicit negation for the current user. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
