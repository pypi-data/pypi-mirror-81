...
def demonstrate_colored_logging():
    ...
    decorated_levels = []
    defined_levels = bitranox_coloredlogs.find_defined_levels()
    normalizer = bitranox_coloredlogs.NameNormalizer()
    ...
    bitranox_coloredlogs.install(level=os.environ.get('COLOREDLOGS_LOG_LEVEL', ordered_levels[0][1]))
