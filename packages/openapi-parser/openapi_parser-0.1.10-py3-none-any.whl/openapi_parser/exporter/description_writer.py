...
from openapi_parser.model import HavingPath, HavingExtendedDescription
...
class DescriptionWriter(Writer, ABC):
    ...
    def generate_item_description(self, item: HavingExtendedDescription, extra_gen: Optional[Iterator[str]] = None, *, item_type: str, path_item: Optional[HavingPath] = None, compact: bool) -> Iterator[str]:
