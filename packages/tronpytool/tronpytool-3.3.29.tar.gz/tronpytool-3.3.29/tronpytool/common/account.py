...
class Address(object):
    @staticmethod
    def from_hex(address: str) -> bytes:
    ...
    @staticmethod
    def to_hex(address: any) -> Union[str, bytes]:
        """Helper function that will convert a generic value to hex"""

        if type(address) is AttributeDict and hasattr(address, "hex"):
            ...
            raise KeyError("is this not a proper address type, please look for the good one")
