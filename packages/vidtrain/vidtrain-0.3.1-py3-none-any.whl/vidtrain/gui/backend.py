...
class MultiStacks(Panel):
    ...
    def update_stack(self, i=None):
        ...
        self.frame = self.frame  # trigger LinkedStacks check that frame does not exceed the number of planes in the stack resolves issue #16
...
class EvalPlotClasses(FigurePanel):
...
class EvalPlotFrames(EvalPlotClasses):
    def set_x(self):
...
class EvalPlotSums(EvalPlotClasses):
    def set_x(self):
        self.x = np.arange(self.classification.data.shape[0])
...
class EvalPlotJunctions(Panel):
    def __init__(self, master, data: datahandler.interface.MultiImageStackClassification, left_plot_class=EvalPlotClasses, right_plot_class=EvalPlotFrames, height=384):
        Panel.__init__(self, master)
        self.data = data
...
class EvalPlots(EvalPlotJunctions):
    def __init__(self, master, data: datahandler.interface.MultiImageStackClassification, left_plot_class=EvalPlotClasses, right_plot_class=EvalPlotSums, height=384):
...
class CompareEvalPlotClasses(EvalPlotClasses):
    def __init__(self, master, isc=None, compare=None, plot='classes', labels=['predictions', 'corrected'], **kw):
        EvalPlotClasses.__init__(self, master, isc=None, **kw)
    ...
    def update(self, isc: datahandler.interface.ImageStackClassification, compare: datahandler.interface.ImageStackClassification):
        self.compare = compare
        EvalPlotClasses.update(self, isc)
...
class CompareEvalPlotFrames(CompareEvalPlotClasses, EvalPlotFrames):
    def __init__(self, master, isc=None, compare=None, plot='classes', labels=['predictions', 'corrected'], **kw):
        CompareEvalPlotClasses.__init__(self, master, isc=None, compare=None, plot='classes', labels=[
...
class CompareEvalPlotSums(CompareEvalPlotClasses, EvalPlotSums):
    def set_x(self):
        EvalPlotSums.set_x(self)
...
class CompareEvalPlotJunctions(EvalPlotJunctions):
    def __init__(self, master, data: datahandler.interface.MultiImageStackClassification, compare: datahandler.interface.MultiImageStackClassification, left_plot_class=CompareEvalPlotClasses, right_plot_class=CompareEvalPlotFrames, height=384, labels=['predictions', 'corrected']):
        super().__init__(master=master, data=data, left_plot_class=left_plot_class, right_plot_class=right_plot_class, height=height)
        self.compare = compare
        self.labels = labels
...
class CompareEvalPlots(CompareEvalPlotJunctions, EvalPlots):
    def __init__(self, master, data: datahandler.interface.MultiImageStackClassification, compare: datahandler.interface.MultiImageStackClassification, left_plot_class=CompareEvalPlotClasses, right_plot_class=CompareEvalPlotSums, height=384, labels=['predictions', 'corrected']):
