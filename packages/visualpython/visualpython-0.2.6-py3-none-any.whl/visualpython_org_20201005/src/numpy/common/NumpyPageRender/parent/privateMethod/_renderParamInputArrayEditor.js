define ([    
     ...
     */
    var _renderParamInputArrayEditor = function(numpyPageRendererThis, tagSelector, bindFuncData, isEmpty = true) {
        ...
        var inputBlockContainer = $(`<div class="vp-numpy-style-flex-row-start"></div>`);
        var uuid = [];
        ...
        for(var i = 0; i < stateParamNameArray.length; i++){
            (function(j) {
                ...
                var inputBlock = $(`<div class="vp-numpy-style-flex-row"
                                        ...
                                        <input type="text" 
                                                class="vp-numpy-input" style="${widthPx}" 
