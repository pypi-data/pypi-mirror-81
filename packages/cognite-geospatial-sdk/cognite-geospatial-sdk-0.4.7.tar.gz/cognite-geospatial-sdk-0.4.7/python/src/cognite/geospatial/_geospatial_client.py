...
class CogniteGeospatialClient:
    ...
    def union(self, items: List[Geometry], output_crs: str, geometry_format: str = "wkt") -> TextBasedGeometry:
        ...
        Returns:
            TextBasedGeometry: the union of input geometries
        """
        ...
        async def union_async(
            ...
            return TextBasedGeometry(crs=response.crs, geojson=response.geojson, wkt=response.wkt)
