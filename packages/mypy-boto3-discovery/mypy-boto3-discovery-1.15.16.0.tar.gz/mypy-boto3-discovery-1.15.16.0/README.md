...
[boto3.ApplicationDiscoveryService 1.15.16](https://boto3.amazonaws.com/v1/documentation/api/1.15.16/reference/services/discovery.html#ApplicationDiscoveryService) service
compatible with
