...
from okera._thrift_api import (
    ...
    TAssignAttributesParams, TAttribute, TAttributeValue, TAuthorizeQueryClient,
    TAuthorizeQueryParams, TCatalogObjectType, TCrawlerParams, TCrawlerOpType,
    TCreateAttributesParams, TDataRegConnection, TDataRegConnectionParams,
...
class PlannerConnection():
    ...
    @_rpc
    def list_catalogs(self, requesting_user='root'):
    ...
    def list_databases_v2(self,
        ...
        tags : list<TAttributeValue>, optional
    ...
    @_rpc
    def list_datasets(self, db, filter=None, name=None, privilege=None):
