...
class Progress:
    ...
    async def aout_err(self, msg: Text = str()):
        await executor(self.out_err, msg)
    ...
    async def aout_ok(self, msg: Text = str()):
        await executor(self.out_ok, msg)
    ...
    async def aout_no(self, msg: Text = str()):
        await executor(self.out_no, msg)
