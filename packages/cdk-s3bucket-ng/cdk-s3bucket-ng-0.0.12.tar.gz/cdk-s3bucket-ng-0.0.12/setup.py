    ...
    """
{
    ...
    "package_data": {
        "cdk_s3bucket_ng._jsii": [
            "cdk-s3bucket-ng@0.0.12.jsii.tgz"
        ],
        "cdk_s3bucket_ng": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-iam>=1.64.1, <2.0.0",
        "aws-cdk.aws-lambda>=1.64.1, <2.0.0",
        "aws-cdk.aws-logs>=1.64.1, <2.0.0",
        "aws-cdk.aws-s3>=1.64.1, <2.0.0",
        "aws-cdk.core>=1.64.1, <2.0.0",
        "aws-cdk.custom-resources>=1.64.1, <2.0.0",
