...
from convo.core.channels.channel import RestInput
from convo.core.constants import DEFAULT_SERVER_URL
from convo.core.interpreter import INTENT_MESSAGE_PREFIX
from convo.utils.io import DEFAULT_ENCODING
from typing import Any, Coroutine

logger = logging.getLogger(__name__)

STREAM_READING_TIMEOUT_ENV = "CONVO_SHELL_STREAM_READING_TIMEOUT_IN_SECONDS"
