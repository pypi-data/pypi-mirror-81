...
class IJenkinsProvider(_IConstruct_db0cc7e3, typing_extensions.Protocol):
...
class _IJenkinsProviderProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk-experiment.aws_codepipeline_actions.IJenkinsProvider"
