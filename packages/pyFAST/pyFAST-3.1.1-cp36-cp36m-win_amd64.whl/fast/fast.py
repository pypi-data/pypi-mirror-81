...
class ProcessObject(Object):
    ...
    def update(self, executeToken: "int"=-1) -> "void":
        ...
        :type executeToken: int, optional
...
class BoundingBoxSetAccess(object):
    ...
    def __init__(self, coordinates: "std::vector< float,std::allocator< float > > *", lines: "std::vector< uint,std::allocator< uint > > *", labels: "std::vector< uchar,std::allocator< uchar > > *", scores: "std::vector< float,std::allocator< float > > *", bbset: "std::shared_ptr< fast::BoundingBoxSet >"):
    ...
    def addBoundingBoxes(self, coordinates: "std::vector< float,std::allocator< float > >", lines: "std::vector< uint,std::allocator< uint > >", labels: "std::vector< uchar,std::allocator< uchar > >", scores: "std::vector< float,std::allocator< float > >") -> "void":
...
class UFFStreamer(Streamer):
    ...
    def setLooping(self, loop: "bool") -> "void":
        return _fast.UFFStreamer_setLooping(self, loop)
...
class InferenceEngine(Object):
    ...
    def getDefaultFileExtension(self) -> "std::string":
        return _fast.InferenceEngine_getDefaultFileExtension(self)
...
class InferenceEngineManager(object):
    ...
    @staticmethod
    def loadBestAvailableEngine() -> "std::shared_ptr< fast::InferenceEngine >":
        return _fast.InferenceEngineManager_loadBestAvailableEngine()
...
def InferenceEngineManager_loadBestAvailableEngine() -> "std::shared_ptr< fast::InferenceEngine >":
    return _fast.InferenceEngineManager_loadBestAvailableEngine()
...
class NeuralNetwork(ProcessObject):
    ...
    def setInputSize(self, name: "std::string", size: "std::vector< int,std::allocator< int > >") -> "void":
...
class MeshAccess(object):
    ...
    def __init__(self, mCoordinates: "std::vector< float,std::allocator< float > > *", mNormals: "std::vector< float,std::allocator< float > > *", mColors: "std::vector< float,std::allocator< float > > *", mLines: "std::vector< uint,std::allocator< uint > > *", mTriangles: "std::vector< uint,std::allocator< uint > > *", mesh: "std::shared_ptr< fast::Mesh >"):
...
class ImagePyramid(SpatialDataObject):
    ...
    def getLevelPatches(self, level: "int") -> "int":
        return _fast.ImagePyramid_getLevelPatches(self, level)
...
class TextRenderer(Renderer):
    ...
    def setViewPosition(self, position: "Vector2f", centerPosition: "float"=True) -> "void":
        ...
        :param position:
        :type centerPosition: float, optional
