...
class Array(_object):
    ...
    __swig_setmethods__["origin"] = _VisusKernelPy.Array_origin_set
    __swig_getmethods__["origin"] = _VisusKernelPy.Array_origin_get
    if _newclass:
        origin = _swig_property(_VisusKernelPy.Array_origin_get, _VisusKernelPy.Array_origin_set)
