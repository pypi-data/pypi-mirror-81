...
class ItemDomainInventory(object):
    ...
    def __init__(self, location=None, tag=None, status_property_type_name=None, catalog_item=None, serial_number=None, import_location_item=None, local_vars_configuration=None):  # noqa: E501
