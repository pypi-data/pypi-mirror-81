...
def delete_data_store_entries(
    ...
    :param int customerID: Specify datastore to delete entries from (default is users customer):param json:
...
def get_entries_from_store_simplified(
    ...
    :param bool includeDeleted: Include deleted/expired keys:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_single_entry(
    ...
    :param bool includeDeleted: Include deleted/expired key:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def put_data_store_entries(
    ...
    :param list entries: Entries to add :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def put_single_data_store_entry(
    ...
    :param int customerID: Specify datastore to put entry to (default is users customer):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
