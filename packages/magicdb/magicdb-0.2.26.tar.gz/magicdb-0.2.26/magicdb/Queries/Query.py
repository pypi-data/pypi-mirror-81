...
class Query:
    ...
    def stream_span(self, **kwargs):
        # with SpanManager("query-stream-firestore") as span_man:
        with safe_span("query-stream-firestore") as span_man:
            print("SPAN MAN", span_man)
            print("span man d", span_man.__dict__)
    ...
    def get_span(self, id=None, **kwargs):

        with SpanManager("query-get-firestore"):
            return (
