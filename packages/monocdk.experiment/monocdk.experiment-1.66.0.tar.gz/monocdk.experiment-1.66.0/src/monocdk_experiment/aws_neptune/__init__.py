...
class CfnDBCluster(
    ...
    def __init__(
        ...
        *,
        ...
        use_latest_restorable_time: typing.Optional[typing.Union[builtins.bool, _IResolvable_9ceae33e]] = None,
    ...
    def associated_roles(
        self,
        value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDBCluster.DBClusterRoleProperty", _IResolvable_9ceae33e]]]],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_neptune.CfnDBCluster.DBClusterRoleProperty",
        jsii_struct_bases=[],
