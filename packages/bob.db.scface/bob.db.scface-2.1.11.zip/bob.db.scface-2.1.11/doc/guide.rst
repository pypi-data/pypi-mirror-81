...
The :py:class:`bob.db.scface.Database` complies with the standard biometric verification database as described in `bob.db.base <bob.db.base>`, implementing both interfaces :py:class:`bob.db.base.SQLiteDatabase`.
