...
[boto3.PersonalizeEvents 1.15.14](https://boto3.amazonaws.com/v1/documentation/api/1.15.14/reference/services/personalize-events.html#PersonalizeEvents) service
compatible with
