from dbex.decoder import DBEXDecodeError
...
##### COMPABILITY
    ...
    def test_json_comp(self):
        ...
        result = dec._Decoder__convert(
            lambda: dec._Decoder__tokenize_control(tester))
...
###### CONVERT DICT
    ...
    def test_convert_dict_1(self):
        ...
        result = dec._Decoder__convert(
            lambda: dec._Decoder__tokenize_control(str(correct_result)))
