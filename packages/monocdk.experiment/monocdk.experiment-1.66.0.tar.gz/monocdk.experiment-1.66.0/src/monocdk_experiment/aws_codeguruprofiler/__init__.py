...
class CfnProfilingGroup(
    ...
    def anomaly_detection_notification_configuration(
        self,
        value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnProfilingGroup.ChannelProperty", _IResolvable_9ceae33e]]]],
    ) -> None:
...
class IProfilingGroup(_IResource_72f7ee7e, typing_extensions.Protocol):
...
class _IProfilingGroupProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk-experiment.aws_codeguruprofiler.IProfilingGroup"
