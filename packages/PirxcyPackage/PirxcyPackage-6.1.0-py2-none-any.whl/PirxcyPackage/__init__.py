...
print(crayons.cyan(f'[PirxcyBot] [{time()}] Made By Pirxcy.'
                   'Sub To Pirxcy on. YT.'))
...
client = commands.Bot(
    ...
    status=("Made By Pirxcy {party_size} / {party_max_size} in Party"),
