...
[boto3.ElasticInference 1.15.16](https://boto3.amazonaws.com/v1/documentation/api/1.15.16/reference/services/elastic-inference.html#ElasticInference) service
compatible with
