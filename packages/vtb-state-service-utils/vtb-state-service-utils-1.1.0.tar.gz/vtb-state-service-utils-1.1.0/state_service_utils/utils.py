...
from .enums import ActionType, ActionStatus, ActionSubType, EventType, EventSubType, EventVirtualization
...
async def add_event(*, action: OrderAction, item_id: str, virtualization: EventVirtualization,
                    type: EventType, subtype: EventSubType, status='', data=None, parent: str = None):
    data = {
        'item_id': item_id,
