...
from convo.constants import DOCS_URL_CONNECTORS
from convo.core.channels.channel import UserMessage, OutputChannel, InputChannel
    ...
    def from_credentials(cls, credentials: Optional[Dict[Text, Any]]) -> InputChannel:
        ...
        if credentials.get("pw") is not None or credentials.get("user") is not None:
            raise_warning(
                ...
                "authentication will be removed in Convo Open Source 2.0.",
                FutureWarning,
