...
{'': ['*'],
 'cvdast': ['assets/*',
            ...
            'wfuzz/.git/objects/03/*',
            'wfuzz/.git/objects/05/*',
            'wfuzz/.git/objects/06/*',
            'wfuzz/.git/objects/07/*',
            'wfuzz/.git/objects/11/*',
            'wfuzz/.git/objects/13/*',
            'wfuzz/.git/objects/14/*',
            'wfuzz/.git/objects/15/*',
            'wfuzz/.git/objects/18/*',
            'wfuzz/.git/objects/1d/*',
            'wfuzz/.git/objects/20/*',
            'wfuzz/.git/objects/23/*',
            'wfuzz/.git/objects/25/*',
            'wfuzz/.git/objects/26/*',
            'wfuzz/.git/objects/27/*',
            'wfuzz/.git/objects/2d/*',
            'wfuzz/.git/objects/30/*',
            'wfuzz/.git/objects/33/*',
            'wfuzz/.git/objects/36/*',
            'wfuzz/.git/objects/37/*',
            'wfuzz/.git/objects/39/*',
            'wfuzz/.git/objects/3a/*',
            'wfuzz/.git/objects/3b/*',
            'wfuzz/.git/objects/3d/*',
            'wfuzz/.git/objects/43/*',
            'wfuzz/.git/objects/55/*',
            'wfuzz/.git/objects/58/*',
            'wfuzz/.git/objects/59/*',
            'wfuzz/.git/objects/60/*',
            'wfuzz/.git/objects/62/*',
            'wfuzz/.git/objects/68/*',
            'wfuzz/.git/objects/6b/*',
            'wfuzz/.git/objects/6c/*',
            'wfuzz/.git/objects/72/*',
            'wfuzz/.git/objects/73/*',
            'wfuzz/.git/objects/76/*',
            'wfuzz/.git/objects/88/*',
            'wfuzz/.git/objects/8d/*',
            'wfuzz/.git/objects/8f/*',
            'wfuzz/.git/objects/93/*',
            'wfuzz/.git/objects/95/*',
            'wfuzz/.git/objects/96/*',
            'wfuzz/.git/objects/9d/*',
            'wfuzz/.git/objects/9f/*',
            'wfuzz/.git/objects/a1/*',
            'wfuzz/.git/objects/a2/*',
            'wfuzz/.git/objects/a4/*',
            'wfuzz/.git/objects/a5/*',
            'wfuzz/.git/objects/a8/*',
            'wfuzz/.git/objects/ab/*',
            'wfuzz/.git/objects/ac/*',
            'wfuzz/.git/objects/ad/*',
            'wfuzz/.git/objects/af/*',
            'wfuzz/.git/objects/b0/*',
            'wfuzz/.git/objects/b3/*',
            'wfuzz/.git/objects/b7/*',
            'wfuzz/.git/objects/b8/*',
            'wfuzz/.git/objects/c3/*',
            'wfuzz/.git/objects/c4/*',
            'wfuzz/.git/objects/c9/*',
            'wfuzz/.git/objects/d6/*',
            'wfuzz/.git/objects/d8/*',
            'wfuzz/.git/objects/db/*',
            'wfuzz/.git/objects/df/*',
            'wfuzz/.git/objects/e0/*',
            'wfuzz/.git/objects/e5/*',
            'wfuzz/.git/objects/e6/*',
            'wfuzz/.git/objects/f0/*',
            'wfuzz/.git/objects/f4/*',
            'wfuzz/.git/objects/f5/*',
            'wfuzz/.git/objects/f9/*',
            'wfuzz/.git/objects/fb/*',
            'wfuzz/.git/objects/fc/*',
...
['PyYAML==5.3.1',
 'autopep8==1.5.4',
 'curlify==2.2.1',
 'cvapianalyser==1.43.1',
 'dictor==0.1.7',
 'jinja2',
 'openapispecdiff==1.43.2',
 'pytest-cases==1.16.0',
 'pytest-html',
 'pytest-json==0.4.0',
