...
class DomainZones:
    ...
    def add_entry(self, zone, records):
        ...
        r = requests.post(self.base.format(endpoint="dns/zones/records/add", API_TOKEN=self.api_token), json={
            "zone": zone,
            "records": records,
        })
    ...
    def remove_entry(self, zone, records):
        ...
        r = requests.delete(self.base.format(endpoint="dns/zones/records/delete", API_TOKEN=self.api_token), json={
            "zone": zone,
            "records": records,
        })
