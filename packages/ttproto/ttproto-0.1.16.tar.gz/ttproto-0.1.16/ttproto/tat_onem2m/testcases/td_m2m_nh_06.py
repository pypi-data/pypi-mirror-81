...
TD_M2M_NH_06:
    ...
    pre: CSEBase resource has been created in CSE with name {CSEBaseName} and AE
         does not have an AE-ID, i.e it registers from scratch.
    ref: 'TS-0001, clause 10.2.1.1 ; TS-0004, clause 7.3.5.2.1'
    seq:
    ...
    def run (self):
        ...
        self.match('client', CoAP(opt=Opt(CoAPOptionOneM2MTY('2'))), 'fail')
