...
class Ui_Param_NTC(object):
    def setupUi(self, Param_NTC):
        ...
        self.label_23 = QLabel(Param_NTC)
    ...
    def retranslateUi(self, Param_NTC):
        ...
        self.label_23.setText(QCoreApplication.translate("Param_NTC", u"M", None))
        self.label.setText(QCoreApplication.translate("Param_NTC", u"N", None))
        self.label1.setText(QCoreApplication.translate("Param_NTC", u"K", None))
