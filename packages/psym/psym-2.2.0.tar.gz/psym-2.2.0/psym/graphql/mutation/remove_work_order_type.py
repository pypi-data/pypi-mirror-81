...
@dataclass
class RemoveWorkOrderTypeMutation(DataClassJsonMixin):
    @dataclass
    class RemoveWorkOrderTypeMutationData(DataClassJsonMixin):
        removeWorkOrderType: str

    data: RemoveWorkOrderTypeMutationData
    ...
    def execute(cls, client: GraphqlClient, id: str) -> str:
        ...
        try:
            ...
            client.reporter.log_successful_operation("RemoveWorkOrderTypeMutation", variables, network_time, decode_time)
