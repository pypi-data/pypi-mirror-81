...
def launch_task(name, args=(), kwargs=None, user=None, keep=False, notify=False):
    ...
    :param keep: (optional) Flag indicating wether the task should be kept in the
        database. See also :class:`.Task`.
    :param notify: (optional) Flag indicating wether the user that started the task
        ...
        well.
    :return: A boolean indicating wether the task was launched successfully or not if
