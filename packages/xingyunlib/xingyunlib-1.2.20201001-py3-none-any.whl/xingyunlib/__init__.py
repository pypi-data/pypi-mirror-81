# from PYGAME import *
# print("ccc",t=0.1)
# b=xesapp("http://code.xueersi.com/home/project/detail?lang=code&pid=5361859&version=offline&form=python&langType=python")
#
# print(b.get_code())
# from xingyunlib.color import *
__all__=["color","code","err"]
# from . import color,code,err
def help_xesapp():
	_ver = "2.2.0"
	_mit = "正式版"
	_logo = """
