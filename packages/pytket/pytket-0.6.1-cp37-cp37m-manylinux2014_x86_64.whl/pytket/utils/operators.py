...
from typing import Dict, TYPE_CHECKING, Union, List, Optional, Set
import numpy as np
...
from .results import get_n_qb_from_statevector
...
class QubitPauliOperator:
    ...
    def __init__(
        self,
        dictionary: Dict[QubitPauliString, CoeffType] = None,
    ):
        self._dict = dict()
        if dictionary:
            self._dict = dict(
    ...
    def __setitem__(self, key: QubitPauliString, value: CoeffType):
    ...
    def __iadd__(self, addend: "QubitPauliOperator"):
    ...
    def __add__(self, addend: "QubitPauliOperator"):
    ...
    def __rmul__(self, multiplier: CoeffType):
    ...
    def compress(self, abs_tol: float = 1e-10):
