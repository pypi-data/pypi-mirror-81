define([
    ...
    , 'nbextensions/visualpython/src/numpy/common/NumpyStateGenerator/parent/NumpyStateGenerator'
             ...
             numpyCodeGeneratorList, numpyCodeValidatorList, numpyPageRenderList, NumpyStateGenerator ) {
    "use strict";

    const { NpArrayCodeGenerator, NpArangeCodeGenerator, NpReshapeCodeGenerator, NpZerosCodeGenerator, NpOnesCodeGenerator,
    ...
    const { NpArangePageRender, NpArrayPageRender, NpReshapePageRender, NpZerosOnesEmptyPageRender, NpEyePageRender,
    ...
    const numpyFunctionBluePrintList = [
        ...
        // {// FIXME: 임시
        //     funcName: "numpy Make ndArray"
        //     , funcId: "JY103"
        //     , htmlUrlPath: "numpy/pageList/operationList/makeArray/index.html"
        //     , stepCount: 1
        //     , numpyCodeGenerator: new MakeArrayCodeGenerator()
        //     , numpyCodeValidator: ""
        //     , numpyPageRender: [ 
        //         new NpArrayPageRender(numpyOptionObj),
        //         new NpArangePageRender(numpyOptionObj), 
        //         new NpReshapePageRender(numpyOptionObj) 
        //     ] 
        //     , numpyStateGenerator: NumpyStateGenerator
        //     , state: {
