...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.4.0-alpha.1602261517+d9cc89f5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.4.0-alpha.1602261517+d9cc89f5`
                """)
            else:
                raise
