...
[boto3.IoTSecureTunneling 1.15.16](https://boto3.amazonaws.com/v1/documentation/api/1.15.16/reference/services/iotsecuretunneling.html#IoTSecureTunneling) service
compatible with
