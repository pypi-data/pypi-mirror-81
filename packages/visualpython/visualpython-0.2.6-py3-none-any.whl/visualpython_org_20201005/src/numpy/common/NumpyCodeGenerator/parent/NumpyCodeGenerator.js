    ...
    */
    NumpyCodeGenerator.prototype.makeNumpyFunctionCode = function(codeObject) {
        ...
        if (isPrintReturnVar === true) {
            sbCode.appendFormatLine(`{0}{1}np.${numpyFunctionName}({2},{3})`, `${indentSpace}`,`${_returnVarStrOrNull}`, `${paramStr}`, `${dtypeStr}`);
            this._appendPrintReturnVar(returnVarStrOrNull);
        } else {
            sbCode.appendFormat(`{0}{1}np.${numpyFunctionName}({2},{3})`, `${indentSpace}`,`${_returnVarStrOrNull}`, `${paramStr}`, `${dtypeStr}`);
        }
