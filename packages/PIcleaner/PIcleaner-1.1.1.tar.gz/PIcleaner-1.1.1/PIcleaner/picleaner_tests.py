...
# def test_lemmatize(cleaner):
#     text = 'Sebastian Talamoni is een echte goed voetballer die woont in Nieuwegein'
#     result = cleaner.lemmatize(text)
#     assert(len(result) == 11)
#     assert(result[0] == 'sebastian')
#     assert(result[1] == 'talamoni')
#     assert(result[2] == 'zijn')
#     assert(result[3] == 'een')
#     assert(result[4] == 'echt')
#     assert(result[5] == 'goed')
#     assert(result[6] == 'voetballer')
#     assert(result[7] == 'die')
#     assert(result[8] == 'wonen')
#     assert(result[9] == 'in')
#     assert(result[10] == 'nieuwegein')

#     text = 'winkeltje'
#     result = cleaner.lemmatize(text)
#     assert(result[0] == 'winkel')
