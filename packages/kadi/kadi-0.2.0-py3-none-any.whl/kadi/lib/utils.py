...
def create_pagination(total, page, per_page, num_pages=9):
    ...
    :return: Pagination object with the following attributes:
        ...
        * **has_next**: Flag indicating wether there is another page after the current
          one.
        * **has_prev**: Flag indicating wether there is another page before the current
          one.
    """
...
def is_iterable(value, include_string=False):
    ...
    :param include_string: (optional) Flag indicating wether a string value should be
