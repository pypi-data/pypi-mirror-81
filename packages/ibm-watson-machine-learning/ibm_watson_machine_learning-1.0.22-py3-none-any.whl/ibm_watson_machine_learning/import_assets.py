...
class Import(WMLResource):
    ...
    def start(self, file_path=None, space_id=None, project_id=None):
        """
            Start the import. Either space_id or project_id has to be provided and is mandatory.
        ...
        print("import job {} has started. Monitor status using client.import_assets.get_details({})".format(import_id,import_id))
