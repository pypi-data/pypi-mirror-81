...
{'': ['*'],
 'google-stubs': ['api/*',
                  'logging/*',
                  'logging/type/*',
                  'longrunning/__init__.pyi',
                  'longrunning/__init__.pyi',
                  'longrunning/operations_pb2.pyi',
                  'longrunning/operations_pb2.pyi',
                  'rpc/*',
                  'type/__init__.pyi',
                  'type/__init__.pyi',
...
install_requires = \
['googleapis-common-protos>=1.52.0,<2.0.0', 'typing-extensions>=3.7,<4.0']
