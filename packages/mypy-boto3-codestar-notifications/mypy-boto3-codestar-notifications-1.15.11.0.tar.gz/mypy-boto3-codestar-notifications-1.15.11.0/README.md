...
[boto3.CodeStarNotifications 1.15.11](https://boto3.amazonaws.com/v1/documentation/api/1.15.11/reference/services/codestar-notifications.html#CodeStarNotifications) service
compatible with
