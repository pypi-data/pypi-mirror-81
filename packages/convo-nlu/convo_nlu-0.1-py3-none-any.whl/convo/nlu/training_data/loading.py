...
from convo.nlu.training_data.formats import markdown
from convo.nlu.training_data.formats.dialogflow import (
    DIALOGFLOW_AGENT,
    DIALOGFLOW_ENTITIES,
...
def _reader_factory(fformat: Text) -> Optional["TrainingDataReader"]:
    ...
    from convo.nlu.training_data.formats import (
        MarkdownReader,
        WitReader,
        LuisReader,
        ConvoReader,
...
def _guess_format(filename: Text) -> Text:
    logger.warning(
        "Using '_guess_format()' is deprecated since Convo 1.1.5. "
