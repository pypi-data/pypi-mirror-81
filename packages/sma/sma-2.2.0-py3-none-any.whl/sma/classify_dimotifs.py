            ...
            if self.G.has_edge(b1, b2) ^ self.G.has_edge(b2, b1):
                ...
                if cl2a == 'A':
                    ...
                    if ((self.G.has_edge(a1, b1) or self.G.has_edge(b1, a1)) and
                        self.G.has_edge(a2, b1) or self.G.has_edge(b1, a2)):
                        # rooted in b1
                        cl2b = ''.join(_classifySymDi12Gadget(self.G, b1, a1, a2))
                    else:
                        # rooted in b2
                        cl2b = ''.join(_classifySymDi12Gadget(self.G, b2, a1, a2))
                elif cl2a == 'D':
                    if ((self.G.has_edge(a1, b1) or self.G.has_edge(b1, a1)) and
                        self.G.has_edge(a1, b2) or self.G.has_edge(b2, a1)):
                        # rooted in a1
                        cl2b = ''.join(_classifySymDi12Gadget(self.G, a1, b1, b2))
                    else:
                        # rooted in a2
                        cl2b = ''.join(_classifySymDi12Gadget(self.G, a2, b1, b2))
                elif cl2a == 'E':
                    if ((self.G.has_edge(a1, b1) or self.G.has_edge(b1, a1)) and
                        self.G.has_edge(a2, b2) or self.G.has_edge(b2, a2)):
