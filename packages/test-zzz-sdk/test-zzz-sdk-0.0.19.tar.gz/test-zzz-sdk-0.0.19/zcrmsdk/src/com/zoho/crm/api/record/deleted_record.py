...
class DeletedRecord(object):
	...
	def set_deleted_time(self, deleted_time):
		...
		if deleted_time is not None and not isinstance(deleted_time, datetime.datetime):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: deleted_time EXPECTED TYPE: datetime.datetime', None, None)
