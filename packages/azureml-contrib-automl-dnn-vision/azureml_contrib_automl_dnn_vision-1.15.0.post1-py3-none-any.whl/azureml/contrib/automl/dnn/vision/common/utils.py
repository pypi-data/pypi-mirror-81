...
from .constants import RunPropertyLiterals, SystemSettings, SettingsLiterals
...
def _exception_handler(func):
    """Decorates a function to handle uncaught exceptions and
    fail the run with System Error."""
...
def _save_image_lf(train_ds=None, val_ds=None, output_dir=None):
    ...
    :param train_ds: train file or dataset (CommonObjectDetectionSubsetWrapper)
    :type train_ds: str
    :param val_ds: validation file or dataset (CommonObjectDetectionSubsetWrapper)
    :type val_ds: str
    :param output_dir: where to save
    :type output_dir: str
    """
