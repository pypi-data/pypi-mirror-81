...
import numpy as np
import os, uuid
from vulcan_athena.mirandareporting.setup import CONNECTION_STRING
from azure.storage.blob import BlobServiceClient, BlobClient, ContainerClient, __version__

CONTAINER_NAME = "container-test-output"
...
def dashboard_files_new(master_dict, inventory_dict, deal_dict, dict_df, year):
    ...
    blob_writer(sales_df, year + 'Sales_Summary' + '.csv')
    ...
    blob_writer(sales_df, year + 'Sales' + '.csv')
    ...
    blob_writer(sales_df, year + 'Inventory' + '.csv')
    ...
    blob_writer(sales_df, year + 'DealRef_Summary' + '.csv')
