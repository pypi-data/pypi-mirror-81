...
class CfnInclude(
    ...
    def get_condition(self, condition_name: builtins.str) -> _CfnCondition_548166d0:
    ...
    def get_hook(self, hook_logical_id: builtins.str) -> _CfnHook_ca75538d:
    ...
    def get_mapping(self, mapping_name: builtins.str) -> _CfnMapping_b46343a2:
    ...
    def get_output(self, logical_id: builtins.str) -> _CfnOutput_1185605a:
    ...
    def get_parameter(self, parameter_name: builtins.str) -> _CfnParameter_90f1d0df:
    ...
    def get_resource(self, logical_id: builtins.str) -> _CfnResource_7760e8e4:
    ...
    def get_rule(self, rule_name: builtins.str) -> _CfnRule_a373f272:
