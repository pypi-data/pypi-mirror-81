...
def error_stats(
    ...
    :param bool includeDetails: If true, include detailed error statistics per processing node:param json:
...
def get(
    ...
    :param int id: ID of filter to fetch:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def hit_stats(
    ...
    :param bool includeDetails: If true, include details about hits per processing node:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def move_filter(
    ...
    :param bool global: Set to true to move filter to a global filter. If true, customer cannot be specified. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search(
    ...
    :param list sortBy: Order results by these properties (prefix with - to sort descending) :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def set_log_level(
    ...
    :param int instanceID: ID of component instance to set log level for event filter, if not provided will set across instances :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
