...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '1.1.0-alpha.1601931967+fb61ec7a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 1.1.0-alpha.1601931967+fb61ec7a`
                """)
            else:
                raise
