...
In short, minionize tranforms your program into a micro-service usable in
various platforms (Igrida, Grid'5000, Kubernetes ...).
...
**Minionize** can record some statistics about the running minions.
It exposes an api to retrieve the stats and basic cli to display some of them
(to be honest, I dream of an ``mtop``: ``htop`` for minions). Currently it
looks more or less to:
