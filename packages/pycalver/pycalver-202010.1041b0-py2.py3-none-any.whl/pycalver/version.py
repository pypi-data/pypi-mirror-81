...
V2VersionInfo = typ.NamedTuple('V2VersionInfo', [('year_y', MaybeInt), (
    ...
    ('num', int), ('bid', str), ('tag', str), ('pytag', str), ('inc0', int),
    ('inc1', int)])
TODAY = dt.datetime.utcnow().date()
RELEASE_BY_PEP440_TAG = {'a': 'alpha', 'b': 'beta', '': 'final', 'rc': 'rc',
    'dev': 'dev', 'post': 'post'}
PEP440_TAG_BY_RELEASE = {'a': 'a', 'b': 'b', 'dev': 'dev', 'alpha': 'a',
    'beta': 'b', 'preview': 'rc', 'pre': 'rc', 'rc': 'rc', 'c': 'rc',
    'final': '', 'post': 'post', 'r': 'post', 'rev': 'post'}
...
PART_ZERO_VALUES = {'MAJOR': '0', 'MINOR': '0', 'PATCH': '0', 'RELEASE':
    'final', 'PYTAG': '', 'NUM': '0', 'INC0': '0'}
V2_FIELD_INITIAL_VALUES = {'major': '0', 'minor': '0', 'patch': '0', 'tag':
    'final', 'pytag': '', 'num': '0', 'inc0': '0', 'inc1': '1'}
