...
from ibm_watson_machine_learning.tests.utils import get_wml_credentials, is_cp4d, get_space_id
...
class TestAutoAIRemote(unittest.TestCase):
    ...
    data_location = '/datasets/iris_dataset.csv'
    custom_separator = ','
    ...
    asset_id = '355bc6a7-31d5-4cfb-b88c-2397551eb01e'
    ...
    def test_02_save_remote_data_and_DataConNection_setup(self):
        TestAutoAIRemote.data_connection = DataConnection(connection=NFSConnection(asset_id=self.asset_id),
