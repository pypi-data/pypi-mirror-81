...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, repository_version=None, base_path=None, content_guard=None, pulp_href=None, pulp_created=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
