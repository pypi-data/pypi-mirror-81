...
def plot_p_value(H0:"GraphMetricsMixin", data:Iterable, threshold:float, metric:str="mse", ax:Optional=None) -> None:
    """
    ...
    ax.set_title("Significance of threshold value")
    ax.set_ylabel("Probability density")
    ax.set_xlabel("Hypotheses coordinate axis")
