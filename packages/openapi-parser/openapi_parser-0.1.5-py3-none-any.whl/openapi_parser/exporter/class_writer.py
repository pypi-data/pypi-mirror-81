...
class ClassWriter(Exporting, AttributeWriter, Writer):
    def dump_class_description(self, cls: HavingExtendedDescription, *, cls_all_required_properties: List[str] = None) -> Iterator[str]:
    ...
    def dump_enum(self, schema: ModelSchema, enum_filter: EnumFilter) -> Iterator[str]:
        ...
        with self.indent():
            yield from self.dump_class_description(schema)
