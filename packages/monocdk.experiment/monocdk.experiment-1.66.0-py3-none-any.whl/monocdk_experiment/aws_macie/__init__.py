...
class CfnFindingsFilter(
    ...
    def finding_criteria(
        self,
        value: typing.Union["CfnFindingsFilter.FindingCriteriaProperty", _IResolvable_9ceae33e],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_macie.CfnFindingsFilter.FindingsFilterListItemProperty",
        jsii_struct_bases=[],
