...
class Project:
    ...
    def __init__(self, params):
        ...
        self.sum_refresh_date = params[66].strip() if len(params)> 66 else None
        self.trsrcsum_loaded = params[67].strip() if len(params) > 67 else None
    ...
    @property
    def resources(self):
        return Resources.get_by_project(self.proj_id
                                        )
    def __repr__(self):
