...
def create_property_mapper(
    ...
    :param str description: The property mapper description (default null) => [\s\w\{\}\$\-\(\)\.\[\]"\'_/\\,\*\+\#:@!?;=]*:param json:
...
def delete_property_mapper(
    ...
    :param str idOrShortName: ID or shortname of a property mapper:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_property_mapper(
    ...
    :param bool includeConfig: Whether to include the property mapper config too:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def list_property_mappers(
    ...
    :param int end: Upper bound timestamp filter value:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def rollback_property_mapper(
    ...
    :param str idOrShortName: ID or shortname of a property mapper
    :param int revision: Revision to rollback to:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_property_mapper(
    ...
    :param str name: Name of the property mapper configuration  => [a-zA-Z0-9_\-\.]*
    :param str configuration: The JSON configuration 
    :param str description: The property mapper description  => [\s\w\{\}\$\-\(\)\.\[\]"\'_/\\,\*\+\#:@!?;=]*:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
