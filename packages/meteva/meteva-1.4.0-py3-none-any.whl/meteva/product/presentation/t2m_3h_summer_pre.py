...
para_example= {
    "begin_time":datetime.datetime(2020,8,29,8,0),
    "end_time":datetime.datetime(2020,8,30,8,0),
    "station_file":meteva.base.station_国家站,
    "defalut_value":999999,
    "interp": meteva.base.interp_gs_linear,
    "hdf_file_name":"summer_test1.h5",
    "ob_data":{
    ...
    "fo_data":{
        "DongQuan": {
            "hdf_dir": r"O:\data\hdf\DongQuan\TMP_2M",
            "dir_fo": r"\\10.20.67.214\disaster\newkgyb\ec\objectived\h\YYMMDDHH.TTT",
            "hour": [8, 20, 12],
            "dtime": [0, 240, 3],
