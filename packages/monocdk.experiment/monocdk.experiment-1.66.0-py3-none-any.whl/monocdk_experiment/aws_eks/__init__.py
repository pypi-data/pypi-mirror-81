...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_eks.AutoScalingGroupCapacityOptions",
...
class AutoScalingGroupCapacityOptions(_CommonAutoScalingGroupProps_43a23fca):
    def __init__(
        self,
        *,
...
class CfnCluster(
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_eks.CfnCluster.KubernetesNetworkConfigProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_eks.LaunchTemplateSpec",
    jsii_struct_bases=[],
