...
def add_group(
    ...
    :param bool daemonAccount: If set, mark the group as a group for daemon accounts (default false):param json:
...
def add_group_members(
    ...
    :param list subject: ID or shortname of subjects to add to the group :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_group(
    ...
    :param str shortNameOrID: Short name or ID of group
    :param str domain: Name or ID of the domain of the group:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def list_groups_1(
    ...
    :param bool includeDeleted: Include deleted groups:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_group(
    ...
    :param str shortName: The shortname of the subject  => Sanitize by regex [a-zA-Z0-9_\-\.@]+
    :param str name: The name of the subject  => [\s\w\{\}\$\-\(\)\.\[\]"\'_/\\,\*\+\#:@!?;=]*
    :param bool daemonAccount: If set, change the daemon flag for this group :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
