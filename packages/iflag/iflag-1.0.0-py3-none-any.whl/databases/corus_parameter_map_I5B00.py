...
PARAMETER_MAP_I5B00 = {
    ...
    "flowrate_unconverted": IFlagParameter(286, data.Float),  # MFRG
    "flowrate_converted": IFlagParameter(287, data.Float),  # MFBG
    "temperature": IFlagParameter(115, data.Float),  # MTG
    "pressure": IFlagParameter(116, data.Float),  # MPG
    "pressure_2": IFlagParameter(398, data.Float)  # MP2G
}
