...
class TD_M2M_NH_12(CoAPTestCase):
    """

TD_M2M_NH_12:
    cfg: M2M_CFG_01
    obj: AE updates attribute in application resource via <container> Update Request
    ...
    ref: 'TS-0001, clause 10.2.4.3 and TS-0004, clause 7.3.5.2.3'
    seq:
    -   s:
        - 'AE is requested to send a PUT request to update the lifetime of <container> resource with:'
        -   - Type = 0 (CON)
            - Code = 3 (PUT)
            - Non-empty payload
    ...
    -   c:
        ...
        -   - Type=0 and Code=3
            ...
            - Non-Empty payload      
    -   v: Check if possible that the <container> resource has been updated in registrar CSE. 
    -   c:
