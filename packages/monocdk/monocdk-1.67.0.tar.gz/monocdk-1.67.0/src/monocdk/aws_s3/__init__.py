...
class CfnBucket(
    ...
    class MetricsProperty:
        def __init__(
            self,
            *,
            event_threshold: typing.Union["CfnBucket.ReplicationTimeValueProperty", _IResolvable_a771d0ef],
            status: builtins.str,
        ) -> None:
            """
    ...
    class SourceSelectionCriteriaProperty:
        def __init__(
            self,
            *,
            sse_kms_encrypted_objects: typing.Union["CfnBucket.SseKmsEncryptedObjectsProperty", _IResolvable_a771d0ef],
        ) -> None:
            """
        ...
        def sse_kms_encrypted_objects(
            self,
        ) -> typing.Union["CfnBucket.SseKmsEncryptedObjectsProperty", _IResolvable_a771d0ef]:
