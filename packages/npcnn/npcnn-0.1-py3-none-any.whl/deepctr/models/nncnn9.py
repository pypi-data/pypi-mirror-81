...
def NNCNN9(linear_feature_columns, dnn_feature_columns, 
         ...
         mlp_feat_filters=((22, 22), (22, 22), (22, 22)), feat_pooling_width=(3, 3), feat_pooling_stride=((2,2), (2,2)), dnn_hidden_units=(128, 64),
    ...
    for i in range(1, l + 1):
        ...
        if i < l:
           ...
           x = tf.keras.layers.MaxPooling2D(pool_size=(1, p_width), strides=(p_stride[0], p_stride[1]))(x)
