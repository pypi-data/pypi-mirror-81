...
class GalPaK3DQuantuumTest(unittest.TestCase, NumpyNdArrayAssertions):
    ...
    fits_folder = os.path.join(root_folder, 'data/input/cube')
    ...
    def test_psf3d(self):
        ...
        fits_folder = os.path.join(self.root_folder, 'data/debug')
        ...
        psf3d_galpak = instr.extrude_psf(image, lsf1d, glpk3d.cube)
