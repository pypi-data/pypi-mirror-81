...
[boto3.ServerlessApplicationRepository 1.15.16](https://boto3.amazonaws.com/v1/documentation/api/1.15.16/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
compatible with
