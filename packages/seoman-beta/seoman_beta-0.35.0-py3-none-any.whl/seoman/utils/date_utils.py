...
def granularity_days(
    granularity: Union[str, date], start: Union[str, date], end: Union[str, date]
) -> List[str]:
    """
...
def get_weekday_by_name(day_name: str) -> Union[str, int]:
    return {
        "monday": 1,
        "tuesday": 2,
        "wednesday": 3,
...
def process_date(dt: Union[str, date, datetime]) -> Union[str, int]:
    """
    ...
    try:
        ...
        enter_new = typer.confirm("Do you want to enter a new date?")
        if enter_new:
