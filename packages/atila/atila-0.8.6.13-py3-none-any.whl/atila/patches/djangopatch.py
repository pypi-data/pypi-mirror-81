...
from rs4.annotations import classproperty
...
class Model (AbstractModel, models.Model):
    ...
    def _check_pk (cls, Qs, filters):
        assert Qs or filters, 'filter required'
    ...
    @classmethod
    def db (cls):
        return was.db (cls._alias)

    @classmethod
    def cursor (cls):
        return was.cursor (cls._alias)

    @classmethod
    def transaction (cls):
        return was.transaction (cls._alias)
