...
[boto3.CloudSearchDomain 1.15.14](https://boto3.amazonaws.com/v1/documentation/api/1.15.14/reference/services/cloudsearchdomain.html#CloudSearchDomain) service
compatible with
