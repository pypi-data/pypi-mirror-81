...
inline void WriterMessage_Feature::set_name(const char* value, size_t size) {
...
inline ::stan::WriterMessage_StringList* WriterMessage_Feature::_internal_mutable_string_list() {
  if (!_internal_has_string_list()) {
    clear_kind();
    set_has_string_list();
    kind_.string_list_ = CreateMaybeMessage< ::stan::WriterMessage_StringList >(
        GetArenaNoVirtual());
  }
...
inline ::stan::WriterMessage_DoubleList* WriterMessage_Feature::_internal_mutable_double_list() {
  if (!_internal_has_double_list()) {
    clear_kind();
    set_has_double_list();
    kind_.double_list_ = CreateMaybeMessage< ::stan::WriterMessage_DoubleList >(
        GetArenaNoVirtual());
  }
...
inline ::stan::WriterMessage_IntList* WriterMessage_Feature::_internal_mutable_int_list() {
  if (!_internal_has_int_list()) {
    clear_kind();
    set_has_int_list();
    kind_.int_list_ = CreateMaybeMessage< ::stan::WriterMessage_IntList >(
        GetArenaNoVirtual());
  }
