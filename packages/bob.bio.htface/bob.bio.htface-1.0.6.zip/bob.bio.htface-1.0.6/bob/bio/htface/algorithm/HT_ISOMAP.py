...
class HT_ISOMAP (HTAlgorithm):
  ...
  def train_projector(self, training_features, projector_file):
    ...
    logger.info("  -> Training ISOMAP reducing to dimension {0} and using {1} components for the reconstruction".format(self.m_subspace_dim, self.m_n_neighbors))
