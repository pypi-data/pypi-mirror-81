...
__all__ = ['debug', 'class_method_debug', 'check_time', 'debugTkinterEvent', 'simple_debug', 'StackTrace', 'StackTraceWithSignature']
...
def simple_debug(func: callable):
    """
        Print the function signature and return value
...
def check_cls_time(*, cls: str or type = None, printSignature: bool = True, tag: str = DEFAULT_TAG):
    """
        Print the function signature and return value
