...
setup(
    ...
    description='SIW Database Access in Bob',

    url='https://gitlab.idiap.ch/bob/bob.db.siw',
    license='GPLv3',
    ...
    entry_points={
        ...
        'bob.db': [
            'siw = bob.db.siw.driver:Interface',
        ],

        'bob.pad.database': [
            'siw = bob.db.siw.config:database',
        ],

        'bob.bio.config': [
            'siw = bob.db.siw.config',
        ],
    },
