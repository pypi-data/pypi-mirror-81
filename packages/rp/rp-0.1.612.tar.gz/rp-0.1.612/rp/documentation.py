...
MICROCOMPLETIONS:
	...
	BACKSLASH COMMANDS:
		...
		WITHOUT ARGUMENTS:
			...
			\wsa  web string paste        (inserts the output of repr(WPASTE) at your cursor position. Use this to paste text from another computer.)
			...
			\tspa tmux string paste              (inserts the output of TPASTE at your cursor position. Use this to paste text from a tmux session. This is useful because often tmux will press the enter key when pasting a multiline string.)
