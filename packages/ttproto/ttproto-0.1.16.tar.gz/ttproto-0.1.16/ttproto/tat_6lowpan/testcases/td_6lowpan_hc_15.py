...
class TD_6LOWPAN_HC_15 (SixlowpanTestCase):
    """
---
TD_6LOWPAN_HC_15:
    cfg: Node-Node
    not: Null
    obj: check that EUTs correctly handle compressed multicasted 6LoWPAN packets (16 bits link-local to
         EUI-64 link-local, hop limit=1 and payload=0)
    pre:
