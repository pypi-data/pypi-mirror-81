...
class Bundling(
    ...
    jsii_type="monocdk-experiment.aws_lambda_nodejs.Bundling",
):
    ...
    def parcel(
        ...
        *,
        ...
        bundling_docker_image: typing.Optional[_BundlingDockerImage_5a43b005] = None,
        ...
        parcel_environment: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        parcel_version: typing.Optional[builtins.str] = None,
        project_root: typing.Optional[builtins.str] = None,
        source_maps: typing.Optional[builtins.bool] = None,
    ) -> _AssetCode_763678ad:
        """(experimental) Parcel bundled Lambda asset code.

        :param entry: (experimental) Entry file.
        :param runtime: (experimental) The runtime of the lambda function.
        ...
        :param bundling_docker_image: (experimental) A custom bundling Docker image. This image should have Parcel installed at ``/``. If you plan to use ``nodeModules`` it should also have ``npm`` or ``yarn`` depending on the lock file you're using. See https://github.com/aws/aws-cdk/blob/master/packages/%40aws-cdk/aws-lambda-nodejs/parcel/Dockerfile for the default image provided by @aws-cdk/aws-lambda-nodejs. Default: - use the Docker image provided by
        :param cache_dir: (experimental) The cache directory (relative to the project root). Parcel uses a filesystem cache for fast rebuilds. Default: - ``.parcel-cache`` in the working directory
        ...
        :param node_modules: (experimental) A list of modules that should be installed instead of bundled. Modules are installed in a Lambda compatible environnment. Default: - all modules are bundled
        :param parcel_environment: (experimental) Environment variables defined when Parcel runs. Default: - no environment variables are defined.
        :param parcel_version: (experimental) The version of Parcel to use when running in a Docker container. Default: - 2.0.0-beta.1
        :param project_root: (experimental) The root of the project. This will be used as the source for the volume mounted in the Docker container. If you specify this prop, ensure that this path includes ``entry`` and any module/dependencies used by your function otherwise bundling will not be possible. Default: - the closest path containing a .git folder
        :param source_maps: (experimental) Whether to include source maps when bundling. Default: false
...
class ParcelBaseOptions:
    ...
    @builtins.property
    def bundling_docker_image(self) -> typing.Optional[_BundlingDockerImage_5a43b005]:
    ...
    def parcel_environment(
        ...
        :stability: experimental
        """
        result = self._values.get("parcel_environment")
        return result

    @builtins.property
    def parcel_version(self) -> typing.Optional[builtins.str]:
        ...
        :stability: experimental
        """
        result = self._values.get("parcel_version")
        return result
    ...
    @builtins.property
    def source_maps(self) -> typing.Optional[builtins.bool]:
        ...
        :stability: experimental
        """
        result = self._values.get("source_maps")
        return result
