...
from convo.core.featurizers import (
    TrackerFeaturizer,
...
from convo.core.constants import DEFAULT_POLICY_PRIORITY, DIALOGUE
...
class TEDPolicy(Policy):
    ...
    def _create_model_data(
        ...
        """Combine all model related data into ConvoModelData."""
        ...
        model_data = ConvoModelData(label_key=LABEL_IDS)
    ...
    def _create_label_data(self, domain: Domain) -> ConvoModelData:
    ...
    def load(cls, path: Text) -> "TEDPolicy":
        ...
        **Needs to load its featurizer**
        ...
        model_data_example = ConvoModelData(label_key=LABEL_IDS, data=loaded_data)
