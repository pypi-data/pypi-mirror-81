...
# dirty hack bitranox to get our testsuite working
try:
...
from bitranox_coloredlogs.converter import capture, convert
from bitranox_coloredlogs.demo import demonstrate_colored_logging
