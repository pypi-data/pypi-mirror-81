...
from convo.nlu.extractors.extractor import EntityExtractor
from convo.nlu.test import determine_token_labels
...
from convo.utils.tensorflow.transformer import TransformerEncoder
from convo.utils.tensorflow.models import ConvoModel
from convo.utils.tensorflow.model_data import ConvoModelData, FeatureSignature
...
from convo.nlu.config import ConvoNLUModelConfig, InvalidConfigError
from convo.nlu.training_data import TrainingData
from convo.nlu.model import Metadata
from convo.nlu.training_data import Message
...
class DIETClassifier(IntentClassifier, EntityExtractor):
    ...
    def __init__(
        ...
        self._label_data: Optional[ConvoModelData] = None
    ...
    def _check_input_dimension_consistency(self, model_data: ConvoModelData) -> None:
    ...
    def _create_model_data(
        ...
        """Prepare data for training and create a ConvoModelData object"""
        ...
        model_data = ConvoModelData(label_key=self.label_key)
    ...
    # train helpers
    def preprocess_train_data(self, training_data: TrainingData) -> ConvoModelData:
    ...
    @staticmethod
    def _check_enough_labels(model_data: ConvoModelData) -> bool:
    ...
    def _load_model(
        ...
        model_data_example = ConvoModelData(label_key=label_key, data=data_example)
        ...
        predict_data_example = ConvoModelData(
            label_key=label_key,
            data={
