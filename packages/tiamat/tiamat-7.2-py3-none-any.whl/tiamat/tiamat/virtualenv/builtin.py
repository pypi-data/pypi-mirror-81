...
def create(hub, bname: str):
    """
    Change up the opts for this build so that they use the appropriate system python directories
    ...
    if hasattr(sys, "frozen"):
        # some venv functions need to be overriden if we are running from a tiamat binary
