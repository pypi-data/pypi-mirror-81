...
def apache(default, out):
    ...
    if default:
        ...
        cert_file = click.prompt("SSL certificate file", default=DEFAULT_CERT_FILE)
        key_file = click.prompt("SSL key file", default=DEFAULT_KEY_FILE)
        chain_file = click.prompt(
            "SSL intermediate certificates chain file (optional)", default=""
        )
