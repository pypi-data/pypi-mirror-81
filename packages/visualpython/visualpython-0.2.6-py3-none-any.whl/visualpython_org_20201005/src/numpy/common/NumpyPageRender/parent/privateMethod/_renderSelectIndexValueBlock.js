define ([    
    ...
    var _renderSelectIndexValueBlock = function(numpyPageRendererThis, title, stateParamNameOrSelectValueDataArray) {
        ...
        var indexBlock = $(`<div class="vp-numpy-block vp-numpy-option-block vp-numpy-${uuid}-block vp-spread" 
                                id="vp_blockArea">
                                <h4>
        ...
        if(Array.isArray(stateParamNameOrSelectValueDataArray)){
            ...
            for(var i = 0; i < stateParamNameOrSelectValueDataArray.length; i++){
                (function(j) {
                    ...
                    var numpySelect = $(`<div class="" style="margin-right:10px;">
                                            <span style="margin-right:5px;">
                                                ${stateParamNameOrSelectValueDataArray 
                                                    && stateParamNameOrSelectValueDataArray[j].selectParamName}
                                            </span>
            ...
            */
            var numpySelect = $(`<select class="vp-numpy-select" id="vp_numpySelect"></select>`);
