...
URLS_AND_METHODS = (
    (FULL_ANALYSIS_PATH, "POST"), (SPECIFIC_RESOURCE_ANALYSIS_PATH, "POST"),
    (IPTC_MEDIA_TOPICS_CLASSIFICATION_PATH, "POST"), (CONTEXTS_PATH, "GET"),
    (CONTEXTS_STANDARD_PATH, "GET"), (TAXONOMIES_LIST_PATH,
                                      "GET"), (IPTC_TAXONOMIES_PATH, "GET")
    )
