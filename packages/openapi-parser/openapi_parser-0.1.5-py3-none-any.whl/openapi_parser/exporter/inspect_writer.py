...
class InspectWriter(Exporting, Writer, ABC):
    ...
    def dump_type_vars(self, items: Iterable[str] = None, *, ordered: bool = None) -> Iterator[str]:
        if (ordered is None):
            ordered = True
        if (items is None):
    ...
    @overload
    def write_type_vars(self, items: Iterable[str] = None, *, ordered: bool = None, file: TextIO) -> None:
        pass
    @writer
    ...
    # noinspection PyOverloads
    @overload
    def write_utils(self, items: Iterable[Any] = None, *, ordered: bool = None, file: TextIO) -> None:
        pass
    @writer
