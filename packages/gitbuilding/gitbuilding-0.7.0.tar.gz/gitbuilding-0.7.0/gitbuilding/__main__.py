...
class GBParser():
    ...
    def __init__(self):
        ...
        self._parser_pdf = subparsers.add_parser("build-pdf", help="Create PDF of documentation (requires WeasyPrint)")
        ...
        self._parser_generate.add_argument("generate_file_type",
                                       ...
                                       nargs="?",
                                       type=str,
                                       help="Type of files to generate, currently only supports `ci`.")
