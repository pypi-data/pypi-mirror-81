...
def undiscretize(data, M, progress_hook = None, tail_factor = 0.5, deterministic = False):
	array_check(data,"data")
...
def create_graph(G, nodes=None, target=None):
	...
	lib.reset_ctx(ctx)
	write_register("EXTI", EXTINF) # TODO: lib.reset_ctx should not delete value of EXTI
