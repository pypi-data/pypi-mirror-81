...
class CfnServer(
    ...
    def endpoint_details(
        self,
        value: typing.Optional[typing.Union["CfnServer.EndpointDetailsProperty", _IResolvable_9ceae33e]],
    ) -> None:
    ...
    def identity_provider_details(
        self,
        value: typing.Optional[typing.Union["CfnServer.IdentityProviderDetailsProperty", _IResolvable_9ceae33e]],
    ) -> None:
...
class CfnUser(
    ...
    def home_directory_mappings(
        self,
        value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnUser.HomeDirectoryMapEntryProperty", _IResolvable_9ceae33e]]]],
    ) -> None:
