...
def add_metric_descriptor(
    ...
    :param bool globalDescriptor: Whether this descriptor is intended for records that are not customer specific. (default false):param json:
...
def delete_metric_descriptor(
    ...
    :param str descriptorDomain: Domain which is used if short name is specified for 'descriptor' parameter. Defaults to current user domain.:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search_metric_descriptors(
    ...
    :param int limit: Set this value to set max number of results. (default 25):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_metric_descriptor(
    ...
    :param bool keepAuditData: Whether to maintain a record of data useful for auditing. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
