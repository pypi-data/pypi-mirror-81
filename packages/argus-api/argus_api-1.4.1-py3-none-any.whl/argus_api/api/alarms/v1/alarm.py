...
def add_alarm(
    ...
    :param int attackCategoryID: Alarm attack category ID (default 0):param json:
...
def add_alarm_comment(
    ...
    :param str comment: Comment content. Html is allowed, will be sanitized.  => format:html:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_alarm(
    ...
    :param int id: ID of Alarm:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_alarm_comment(
    ...
    :param int id: ID of Alarm
    :param int timestamp: Timestamp of comment:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_alarms(
    ...
    :param int offset: Skip a number of alarms:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def map_to_alarm(
    ...
    :param int id: ID of Alarm
    :param list signatures: Signatures (exist/new) to be mapped to the alarm  => Sanitize by regex [a-zA-Z0-9_/:@~!\+\-\.\?]*:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search_alarms(
    ...
    :param bool includeComments: Set to include comments in the search result. (default false):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def unmap(
    ...
    :param int id: ID of Alarm
    :param list signature: Signatures to unmap:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_alarm(
    ...
    :param str internalReference: A link to an internal reference for the alarm  => [\s\w\{\}\$\-\(\)\.\[\]"\'_/\\,\*\+\#:@!?;=]*
    :param int attackCategoryID: Update category of alarm (unchanged if set to 0) (default 0):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
