...
import upip                      # pylint: disable=import-error
import os, sys
...
Examples:
    ...
    %pip install micropython-mimetypes Adafruit-BME280
    %pip -p upip -l lib2 install micropython-uargparse micropython-mpu6886

Implemented with https://pypi.org/project/micropython-cpython-upip and pip3.
    """
    path = os.path.join(Config.get('host_dir', '~'), "mcu", args.project, args.lib)
