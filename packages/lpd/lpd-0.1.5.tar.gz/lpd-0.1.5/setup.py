...
setup(
    ...
    keywords=['pytorch,trainer,callback,callbacks,earlystopping,tensorboard,modelcheckpoint,layers,dense,metrics,extensions,track,monitor,machine,deep,learning,neural,networks']
)