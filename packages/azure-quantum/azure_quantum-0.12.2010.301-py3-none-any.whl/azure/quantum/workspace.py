...
if  sdk_environment('dogfood'):
    ...
    BASE_URL                = os.environ['AZURE_QUANTUM_BASEURL'] if 'AZURE_QUANTUM_BASEURL' in os.environ else "https://app-jobscheduler-test.azurewebsites.net/"
    ...
    if sdk_environment('canary'):
        ...
        BASE_URL                = os.environ['AZURE_QUANTUM_BASEURL'] if 'AZURE_QUANTUM_BASEURL' in os.environ else "https://app-jobs-canarysouthcentralus.azurewebsites.net/"
    else:
...
class Workspace:
    ...
    def __init__(self, subscription_id: str, resource_group: str, name:str, storage: str = None):
        self.name = name
