...
def save_windowed_dataset_hdf5(training_data, training_label, test_data, test_label,
                               ...
                               chunk_size=100):
    for i in tqdm(range(0, len(training_data), chunk_size), desc="Generating sliding window (training) ..."):
        s_idx = i
    ...
    for i in tqdm(range(0, len(test_data), chunk_size), desc="Generating sliding window (test) ..."):
        s_idx = i
