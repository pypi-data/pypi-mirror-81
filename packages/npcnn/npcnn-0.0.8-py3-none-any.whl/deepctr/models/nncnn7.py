...
def NNCNN7(linear_feature_columns, dnn_feature_columns, 
    ...
    pooling_result = tf.keras.layers.AveragePooling3D(pool_size=(ave_pooling_width, ave_pooling_width, ave_pooling_width), strides=ave_stride, padding="valid")(nin_result)
