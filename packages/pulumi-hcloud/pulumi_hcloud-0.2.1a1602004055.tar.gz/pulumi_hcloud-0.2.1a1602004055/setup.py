...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '0.2.1-alpha.1602004055+c53b4f34'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 0.2.1-alpha.1602004055+c53b4f34`
                """)
            else:
                raise
