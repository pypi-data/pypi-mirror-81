    ...
    def _generate_lookup_regex(
        ...
        if isinstance(lookup_elements, list):
            ...
            common_utils.raise_warning(
                "Directly including lookup tables as a list is deprecated since Convo "
                "1.6.",
                FutureWarning,
        ...
        # otherwise it's a file path.
            ...
            try:
                f = open(lookup_elements, "r", encoding=convo.utils.io.DEFAULT_ENCODING)
            except OSError:
                raise ValueError(
    ...
    def load(
        ...
        **kwargs: Any,
        ...
        if os.path.exists(regex_file):
            known_patterns = convo.utils.io.read_json_file(regex_file)
