...
from convo.core.events import UserUttered, ActionExecuted

from convo.core.constants import USER_INTENT_OUT_OF_SCOPE
...
from convo.core.constants import FALLBACK_POLICY_PRIORITY
...
class TwoStageFallbackPolicy(FallbackPolicy):
    ...
    def persist(self, path: Text) -> None:
        ...
        convo.utils.io.create_directory_for_file(config_file)
        convo.utils.io.dump_obj_as_json_to_file(config_file, meta)
    ...
    def load(cls, path: Text) -> "FallbackPolicy":
        ...
        if os.path.exists(path):
            ...
            if os.path.isfile(meta_path):
                meta = json.loads(convo.utils.io.read_file(meta_path))
