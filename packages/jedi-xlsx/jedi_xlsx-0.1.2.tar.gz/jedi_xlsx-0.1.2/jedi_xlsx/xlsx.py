...
from typing import Union, Dict, Optional, Union
...
class XLCell:
    ...
    def offset(self, row: int=0, col: int=0) -> "XLCell":
        return self + self.from_rowcol(row, col, False, False)
...
# %% to_xlsx
def to_xlsx(data: pd.DataFrame, wb: Workbook, ws: Union[str, Worksheet],
