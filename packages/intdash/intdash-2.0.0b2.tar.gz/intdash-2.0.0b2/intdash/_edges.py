...
class Edges(object):
    ...
    def me(self):
        ...
        return intdash.Edge._from_dict(resp)
    ...
    def list(
        ...
        return [intdash.Edge._from_dict(item) for item in resp["items"]]
    ...
    def _iter_lists(
        ...
        yield [intdash.Edge._from_dict(item) for item in resp["items"]]
