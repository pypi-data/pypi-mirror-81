...
# source: konlpy_homi/api/v0alpha/mecab.proto
...
_MECAB = _descriptor.ServiceDescriptor(
  name='Mecab',
  full_name='konlpy_homi.api.v0alpha.Mecab',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Pos',
    full_name='konlpy_homi.api.v0alpha.Mecab.Pos',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Nouns',
    full_name='konlpy_homi.api.v0alpha.Mecab.Nouns',
    index=1,
    containing_service=None,
    input_type=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2._STRINGREQUEST,
  ...
  _descriptor.MethodDescriptor(
    name='Morphs',
    full_name='konlpy_homi.api.v0alpha.Mecab.Morphs',
    index=2,
    containing_service=None,
    input_type=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2._STRINGREQUEST,
    output_type=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2._STRINGARRAYRESPONSE,
