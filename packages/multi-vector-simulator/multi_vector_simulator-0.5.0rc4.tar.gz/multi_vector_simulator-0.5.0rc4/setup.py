...
setup(
    ...
    name="multi_vector_simulator",  # Required
    ...
    package_dir={'multi_vector_simulator': 'src/multi_vector_simulator'},  # Optional
    ...
    package_data={  # Optional
        'multi_vector_simulator': ['input_template/csv_elements/*.csv', 'input_template/time_series/blank'],
    },
