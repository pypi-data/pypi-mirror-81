...
class Notification(object):
	...
	def set_channel_expiry(self, channel_expiry):
		...
		if channel_expiry is not None and not isinstance(channel_expiry, datetime.datetime):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: channel_expiry EXPECTED TYPE: datetime.datetime', None, None)
