...
class MecabStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Pos = channel.unary_unary(
                '/konlpy_homi.api.v0alpha.Mecab/Pos',
        ...
        self.Nouns = channel.unary_unary(
                '/konlpy_homi.api.v0alpha.Mecab/Nouns',
                request_serializer=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.SerializeToString,
        ...
        self.Morphs = channel.unary_unary(
                '/konlpy_homi.api.v0alpha.Mecab/Morphs',
                request_serializer=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.SerializeToString,
                response_deserializer=konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringArrayResponse.FromString,
                )
...
def add_MecabServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'konlpy_homi.api.v0alpha.Mecab', rpc_method_handlers)
...
class Mecab(object):
    ...
    def Pos(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/konlpy_homi.api.v0alpha.Mecab/Pos',
    ...
    def Nouns(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/konlpy_homi.api.v0alpha.Mecab/Nouns',
            konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.SerializeToString,
    ...
    def Morphs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/konlpy_homi.api.v0alpha.Mecab/Morphs',
            konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringRequest.SerializeToString,
            konlpy__homi_dot_api_dot_v0alpha_dot_global__pb2.StringArrayResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
