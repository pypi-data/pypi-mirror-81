...
def client_host_asset_scanned(
    ...
    :param list detectedApplications: Specify sockets of detected applications (e.g. tcp/80). :param json:
...
def host_asset_bulk_scanned(
    ...
    :param list scannedIpRanges: Set of scanned IP address ranges as list of single IPs (1.1.1.1), CIDR networks (1.1.1.0/24) or ranges (1.1.1.1-1.1.1.2) :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
