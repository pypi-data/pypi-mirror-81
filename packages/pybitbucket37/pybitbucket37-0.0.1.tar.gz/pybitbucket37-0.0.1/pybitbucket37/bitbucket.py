...
from pybitbucket37.repository import Repository
from pybitbucket37.user import User
from pybitbucket37.team import Team
from pybitbucket37.snippet import Snippet
from pybitbucket37.ref import Ref
from pybitbucket37.pullrequest import PullRequest
from pybitbucket37.hook import Hook
from pybitbucket37.consumer import Consumer
from pybitbucket37.commit import Commit
from pybitbucket37.comment import Comment
from pybitbucket37.build import BuildStatus
from pybitbucket37.branchrestriction import BranchRestriction
...
from pybitbucket37.auth import Anonymous
from pybitbucket37.entrypoints import entrypoints_json
...
class BitbucketBase(object):
    ...
    def add_remote_relationship_methods(self, data):
        for name, url in BitbucketBase.links_from(data):
            if (name not in BitbucketSpecialAction._value2member_map_):
