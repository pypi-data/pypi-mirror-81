...
class AddHeader(
    ...
    jsii_type="monocdk-experiment.aws_ses_actions.AddHeader",
):
...
class Bounce(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses_actions.Bounce",
):
...
class Lambda(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses_actions.Lambda",
):
...
class Stop(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses_actions.Stop",
):
