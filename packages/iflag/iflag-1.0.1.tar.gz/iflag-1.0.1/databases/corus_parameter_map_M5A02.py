...
PARAMETER_MAP_M5A02 = {
    ...
    "flowrate_unconverted": IFlagParameter(279, data.Float),  # MFRG
    "flowrate_converted": IFlagParameter(280, data.Float),  # MFBG
    "temperature": IFlagParameter(115, data.Float),  # MTG
    "pressure": IFlagParameter(116, data.Float),  # MPG
    "pressure_2": IFlagParameter(391, data.Float)  # MP2G
}
