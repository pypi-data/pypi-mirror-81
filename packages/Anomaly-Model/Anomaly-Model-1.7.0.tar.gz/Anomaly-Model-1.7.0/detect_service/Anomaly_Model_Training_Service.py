...
def print_and_plot_anomaly_score(model_id,model_name,df_join_TF,Problem_object,anomaly_threshold,anomaly_score,percentile_point_95,plot_anomaly_score='YES'):
    ...
    print('=========number of anomaly =============== \n red above percentile_95:',num_red_points_above_95,', bad validation num above threshold:',num_anomaly_threshold, ', total welds above percentile_95:',num_anomaly_above_95)
    ...
    print(num_anomaly_df[['Date','PSN','FailureType','anomaly_score','Level']])
    print('--------------------------------\n')
    print(num_green_df[['Date','PSN','FailureType','anomaly_score','Level']])
