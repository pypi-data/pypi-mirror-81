...
def check_permission(
    ...
    :param str function: Function name:param json:
...
def find_users(
    ...
    :param list customerID: Restrict search to data belonging to specified customers. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_functions(
    ...
    :param int offset: Skip a number of functions:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_user_by_username(
    ...
    :param str userName: Username:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_user_customers(
    ...
    :param str keywordMatch: Set match strategy for keyword search:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_profile_picture_for_user_form(
    ...
    :param str domain: Domain of the user (defaults to current users domain:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_profile_picture_for_user_j_s_o_n(
    ...
    :param str mimeType: The MIME type of the image  => Sanitize by regex .+/.+:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_user_preferences(
    ...
    :param str user: User ID or username
    :param str domain: Domain ID or shortname (optional, defaults to current user domain):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
