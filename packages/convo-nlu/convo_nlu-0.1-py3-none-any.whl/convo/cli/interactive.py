...
from convo.constants import DEFAULT_MODELS_PATH, DEFAULT_ENDPOINTS_PATH
    ...
    if args.model is None:
        ...
        if not (zipped_model and os.path.exists(zipped_model)):
            utils.print_error_and_exit(
                ...
                f"found at path '{args.model}'.  Use 'convo train' to train a model."
            )
...
def perform_interactive_learning(
    ...
    from convo.core.train import do_interactive_learning
