...
class Ui_Preferences(object):
    ...
    def retranslateUi(self, Preferences):
        ...
        self.label_9.setText(_("<html><head/><body><p><span style=\" font-weight:600;\">Backups</span><br/>Anki will create a backup of your collection each time it is closed.</p></body></html>"))
