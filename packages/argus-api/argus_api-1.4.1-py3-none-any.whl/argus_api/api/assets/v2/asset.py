...
def add_asset(
    ...
    :param int ttl: Time to live duration of this asset since last seen, 0 means won't expire. :param json:
...
def add_asset_definition(
    ...
    :param list component: Component definitions (ID or short name) to be included for the asset definition :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_asset(
    ...
    :param bool forceIndex: Whether to force an Elasticsearch index refresh such that the Asset is immediately no longer searchable.:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_asset_definition(
    ...
    :param str domain: Domain ID or name (default is user's domain), only used when definition is short name:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_asset(
    ...
    :param str idOrShortName: Asset ID or short name
    :param str customer: Customer ID or short name (default is user's customer), only used when short name was provided:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_vulnerability_by_asset(
    ...
    :param bool includeRawOutput: Whether include raw output, default not include:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search_asset_definitions(
    ...
    :param int offset: Skip specified amount of results (default 0):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search_assets(
    ...
    :param bool includeDeleted: Whether to include deleted Assets (default false):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_asset(
    ...
    :param bool forceIndex: Whether to force an Elasticsearch index refresh such that changes to the Asset are immediately searchable.:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_asset_definition(
    ...
    :param list deleteComponent: Component definitions ((ID or short name)) to be deleted from the asset definition :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
