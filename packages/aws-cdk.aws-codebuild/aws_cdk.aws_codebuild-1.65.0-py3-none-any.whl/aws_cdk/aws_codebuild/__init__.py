...
class CfnProject(
    ...
    def artifacts(
        self,
        value: typing.Union["ArtifactsProperty", aws_cdk.core.IResolvable],
    ) -> None:
    ...
    def environment(
        self,
        value: typing.Union[aws_cdk.core.IResolvable, "EnvironmentProperty"],
    ) -> None:
    ...
    def source(
        self,
        value: typing.Union["SourceProperty", aws_cdk.core.IResolvable],
    ) -> None:
