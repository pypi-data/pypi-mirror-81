...
def add_data_store_descriptor(
    ...
    :param str dataType: Select data type: list of values or key/value store. (default MAP (key/value store)):param json:
...
def delete_data_store_descriptor(
    ...
    :param str dataStore: Store name:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_descriptor(
    ...
    :param str dataStore: Descriptor name:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_data_store_descriptor(
    ...
    :param int lifeTime: If set (to positive value), change the expiry time for this datastore. Requires that the store has enabled expireData. Default is no change. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
