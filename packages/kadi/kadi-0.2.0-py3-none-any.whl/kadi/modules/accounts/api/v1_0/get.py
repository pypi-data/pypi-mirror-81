...
@qparam(
    "shared",
    "",
    description="Flag indicating wether records the current user created should be"
...
@qparam(
    "shared",
    "",
    description="Flag indicating wether collections the current user created should be"
...
@qparam(
    "shared",
    "",
    description="Flag indicating wether templates the current user created should be"
