        ...
        switch(funcId){
            ...
            case "JY901":{
                ...
                dom = $(`<div class="vp-numpy-style-flex-row-center" style="margin-bottom:5px;">
                                ...
                                <button class="vp-numpy-func_btn vp-numpy-oneArrayEditor-make-btn-${uuid}">생성</button>
                            </div>`);
                baseDom.append(dom);
            ...
            case "JY902":{
                ...
                dom = $(`<div class="vp-numpy-style-flex-row-center" style="margin-bottom:5px;">
                            ...
                            <div style="margin:0 5px;">
                                ...
                                <button class="vp-numpy-func_btn vp-numpy-twoArrayEditor-make-btn-${uuid}">생성</button>
                            </div>`);
                baseDom.append(dom);
            ...
            case "JY903":{
                ...
                dom = $(`<div class="vp-numpy-style-flex-row-center" style="margin-bottom:5px;">
                            ...
                            <div style="margin:0 5px;">
                                ...
                                <button class="vp-numpy-func_btn vp-numpy-threeArrayEditor-make-btn-${uuid}">생성</button>
                            </div>`);
                baseDom.append(dom);
