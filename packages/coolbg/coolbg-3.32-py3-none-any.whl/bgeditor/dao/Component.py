...
class ElementComp(Component):
    def __init__(self, json_data):
        ...
        self.arr_direction = json_data['arr_direction']
        self.rang_locx = json_data['rang_locx']
        self.rang_locy = json_data['rang_locy']
        self.rang_speedx = map(lambda n:n*2,json_data['rang_speedx'])
        self.rang_speedy = map(lambda n:n*2,json_data['rang_speedy'])
        self.rang_opacity = json_data['rang_opacity']
        self.rang_size = json_data['rang_size']
