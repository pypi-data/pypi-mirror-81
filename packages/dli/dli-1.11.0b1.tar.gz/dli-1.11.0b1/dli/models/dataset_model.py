...
import pandas
import pyarrow
from dli.aws import create_refreshing_session, match_partitions
...
class DatasetModel(AttributesDict):
    ...
    def list(
        ...
        * Files with the wrong extension for the dataset's type i.e for
        ...
        self._client.logger.info(
            f"Number of paths on S3 for this dataset: '{len(paths)}'"
        )
    ...
    def dataframe(
        ...
        """
        Return the data from the dataset as a pandas DataFrame.
    ...
    def dictionary(self) -> List[dict]:
        ...
        * metadata
        ...
        :return: List of dictionaries for each field in the dataset.
        """
