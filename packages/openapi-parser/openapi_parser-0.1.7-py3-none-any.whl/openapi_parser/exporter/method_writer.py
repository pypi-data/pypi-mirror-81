...
from functional import OptionNone, Some
from typing.io import *

from openapi_parser.model import ModelEndpoint, ModelMediaTypeObject, ModelResponseObject, ModelClass, ParameterType
...
class MethodWriter(Exporting, AttributeWriter, Writer):
    ...
    @overload
    def write_endpoint(self, e: ModelEndpoint, endpoint_path: str, http_method: str, *, file: TextIO) -> None:
        pass
    @writer
