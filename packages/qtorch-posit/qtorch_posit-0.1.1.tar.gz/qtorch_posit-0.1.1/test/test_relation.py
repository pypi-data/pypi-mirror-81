import torch
import unittest
from qtorch_posit.quant import block_quantize, fixed_point_quantize, float_quantize
from qtorch_posit import FixedPoint, BlockFloatingPoint, FloatingPoint
...
class TestRelation(unittest.TestCase):
    def test_fixed_block_zero_exponent(self):
        ...
        for wl, fl in [(3, 2), (5, 4)]:
            ...
            fixed_quantized = fixed_point_quantize(
                to_quantize, wl=wl, fl=fl, rounding="nearest"
            )
