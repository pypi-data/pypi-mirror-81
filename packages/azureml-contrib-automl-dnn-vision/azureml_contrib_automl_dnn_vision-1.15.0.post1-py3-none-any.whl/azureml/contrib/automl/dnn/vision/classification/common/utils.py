...
from ..common.constants import PackageInfo, ArtifactsLiterals, TrainingLiterals
...
def _get_train_valid_sub_file_paths(output_dir):
    ...
    :rtype: Tuple[str, str]
    """
    new_train_file = os.path.join(output_dir, ArtifactsLiterals.TRAIN_SUB_FILE_NAME)
    new_valid_file = os.path.join(output_dir, ArtifactsLiterals.VAL_SUB_FILE_NAME)
