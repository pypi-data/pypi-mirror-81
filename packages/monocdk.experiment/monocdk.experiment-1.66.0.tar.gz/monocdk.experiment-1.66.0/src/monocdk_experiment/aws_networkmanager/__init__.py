...
class CfnDevice(
    ...
    def location(
        self,
        value: typing.Optional[typing.Union["CfnDevice.LocationProperty", _IResolvable_9ceae33e]],
    ) -> None:
...
class CfnLink(
    ...
    def bandwidth(
        self,
        value: typing.Union["CfnLink.BandwidthProperty", _IResolvable_9ceae33e],
    ) -> None:
...
class CfnSite(
    ...
    def location(
        self,
        value: typing.Optional[typing.Union["CfnSite.LocationProperty", _IResolvable_9ceae33e]],
    ) -> None:
        jsii.set(self, "location", value)
