...
In order for the upstream edx to include a new version of UBCPI, modify
the file
`main.yml <https://github.com/edx/configuration/tree/master/playbooks/roles/edxapp/defaults>`__
and submit a pull request to that repository.

Changelog
---------

`1.0.0 <https://github.com/ubc/ubcpi/issues?q=milestone%3A1.0+is%3Aclosed>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
