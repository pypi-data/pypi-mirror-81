...
from convo.core.domain import PREV_PREFIX, Domain
from convo.core.events import ActionExecuted
from convo.core.trackers import DialogueStateTracker
from convo.core.training.data import DialogueTrainingData
...
class TrackerFeaturizer:
    ...
    def persist(self, path) -> None:
        ...
        convo.utils.io.create_directory_for_file(featurizer_file)

        # noinspection PyTypeChecker
        convo.utils.io.write_text_file(str(jsonpickle.encode(self)), featurizer_file)
    ...
    def load(path) -> Optional["TrackerFeaturizer"]:
        ...
        if os.path.isfile(featurizer_file):
            return jsonpickle.decode(convo.utils.io.read_file(featurizer_file))
        else:
            logger.error(
