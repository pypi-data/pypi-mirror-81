...
class WatchEcsService(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk-watchful.WatchEcsService"):
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, target_group: aws_cdk.aws_elasticloadbalancingv2.ApplicationTargetGroup, title: str, watchful: "IWatchful", ec2_service: typing.Optional[aws_cdk.aws_ecs.Ec2Service]=None, fargate_service: typing.Optional[aws_cdk.aws_ecs.FargateService]=None, cpu_maximum_threshold_percent: typing.Optional[jsii.Number]=None, memory_maximum_threshold_percent: typing.Optional[jsii.Number]=None, requests_threshold: typing.Optional[jsii.Number]=None, target_response_time_threshold: typing.Optional[jsii.Number]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param target_group: 
        ...
        """
        props = WatchEcsServiceProps(target_group=target_group, title=title, watchful=watchful, ec2_service=ec2_service, fargate_service=fargate_service, cpu_maximum_threshold_percent=cpu_maximum_threshold_percent, memory_maximum_threshold_percent=memory_maximum_threshold_percent, requests_threshold=requests_threshold, target_response_time_threshold=target_response_time_threshold)

        jsii.create(WatchEcsService, self, [scope, id, props])


@jsii.data_type(jsii_type="cdk-watchful.WatchEcsServiceOptions", jsii_struct_bases=[], name_mapping={'cpu_maximum_threshold_percent': 'cpuMaximumThresholdPercent', 'memory_maximum_threshold_percent': 'memoryMaximumThresholdPercent', 'requests_threshold': 'requestsThreshold', 'target_response_time_threshold': 'targetResponseTimeThreshold'})
class WatchEcsServiceOptions():
    def __init__(self, *, cpu_maximum_threshold_percent: typing.Optional[jsii.Number]=None, memory_maximum_threshold_percent: typing.Optional[jsii.Number]=None, requests_threshold: typing.Optional[jsii.Number]=None, target_response_time_threshold: typing.Optional[jsii.Number]=None) -> None:
        """
        :param cpu_maximum_threshold_percent: Threshold for the Cpu Maximum utilization. Default: 80
        :param memory_maximum_threshold_percent: Threshold for the Memory Maximum utilization. Default: - 0.
        :param requests_threshold: Threshold for the Number of Requests. Default: - 0.
        ...
        if memory_maximum_threshold_percent is not None: self._values["memory_maximum_threshold_percent"] = memory_maximum_threshold_percent
        if requests_threshold is not None: self._values["requests_threshold"] = requests_threshold
        if target_response_time_threshold is not None: self._values["target_response_time_threshold"] = target_response_time_threshold
    ...
    def memory_maximum_threshold_percent(self) -> typing.Optional[jsii.Number]:
        ...
        -
          0.
        """
        return self._values.get('memory_maximum_threshold_percent')
    ...
    def requests_threshold(self) -> typing.Optional[jsii.Number]:
        ...
        -
          0.
        """
        return self._values.get('requests_threshold')
    ...
    def target_response_time_threshold(self) -> typing.Optional[jsii.Number]:
        ...
        -
          0.
        """
        return self._values.get('target_response_time_threshold')
    ...
    def __repr__(self) -> str:
        return 'WatchEcsServiceOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="cdk-watchful.WatchEcsServiceProps", jsii_struct_bases=[WatchEcsServiceOptions], name_mapping={'cpu_maximum_threshold_percent': 'cpuMaximumThresholdPercent', 'memory_maximum_threshold_percent': 'memoryMaximumThresholdPercent', 'requests_threshold': 'requestsThreshold', 'target_response_time_threshold': 'targetResponseTimeThreshold', 'target_group': 'targetGroup', 'title': 'title', 'watchful': 'watchful', 'ec2_service': 'ec2Service', 'fargate_service': 'fargateService'})
class WatchEcsServiceProps(WatchEcsServiceOptions):
    def __init__(self, *, cpu_maximum_threshold_percent: typing.Optional[jsii.Number]=None, memory_maximum_threshold_percent: typing.Optional[jsii.Number]=None, requests_threshold: typing.Optional[jsii.Number]=None, target_response_time_threshold: typing.Optional[jsii.Number]=None, target_group: aws_cdk.aws_elasticloadbalancingv2.ApplicationTargetGroup, title: str, watchful: "IWatchful", ec2_service: typing.Optional[aws_cdk.aws_ecs.Ec2Service]=None, fargate_service: typing.Optional[aws_cdk.aws_ecs.FargateService]=None) -> None:
        """
        :param cpu_maximum_threshold_percent: Threshold for the Cpu Maximum utilization. Default: 80
        :param memory_maximum_threshold_percent: Threshold for the Memory Maximum utilization. Default: - 0.
        :param requests_threshold: Threshold for the Number of Requests. Default: - 0.
        ...
        if requests_threshold is not None: self._values["requests_threshold"] = requests_threshold
        if target_response_time_threshold is not None: self._values["target_response_time_threshold"] = target_response_time_threshold
        if ec2_service is not None: self._values["ec2_service"] = ec2_service
        if fargate_service is not None: self._values["fargate_service"] = fargate_service
    ...
    def ec2_service(self) -> typing.Optional[aws_cdk.aws_ecs.Ec2Service]:
        return self._values.get('ec2_service')

    @builtins.property
    def fargate_service(self) -> typing.Optional[aws_cdk.aws_ecs.FargateService]:
        return self._values.get('fargate_service')
    ...
    def __repr__(self) -> str:
        return 'WatchEcsServiceProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class Watchful(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk-watchful.Watchful"):
    ...
    def watch_ec2_ecs(self, title: str, ec2_service: aws_cdk.aws_ecs.Ec2Service, target_group: aws_cdk.aws_elasticloadbalancingv2.ApplicationTargetGroup, *, cpu_maximum_threshold_percent: typing.Optional[jsii.Number]=None, memory_maximum_threshold_percent: typing.Optional[jsii.Number]=None, requests_threshold: typing.Optional[jsii.Number]=None, target_response_time_threshold: typing.Optional[jsii.Number]=None) -> "WatchEcsService":
        """
        :param title: -
        :param ec2_service: -
        :param target_group: -
        ...
        :param target_response_time_threshold: Threshold for the Target Response Time. Default: - 0.
        """
        options = WatchEcsServiceOptions(cpu_maximum_threshold_percent=cpu_maximum_threshold_percent, memory_maximum_threshold_percent=memory_maximum_threshold_percent, requests_threshold=requests_threshold, target_response_time_threshold=target_response_time_threshold)

        return jsii.invoke(self, "watchEc2Ecs", [title, ec2_service, target_group, options])

    @jsii.member(jsii_name="watchFargateEcs")
    def watch_fargate_ecs(self, title: str, fargate_service: aws_cdk.aws_ecs.FargateService, target_group: aws_cdk.aws_elasticloadbalancingv2.ApplicationTargetGroup, *, cpu_maximum_threshold_percent: typing.Optional[jsii.Number]=None, memory_maximum_threshold_percent: typing.Optional[jsii.Number]=None, requests_threshold: typing.Optional[jsii.Number]=None, target_response_time_threshold: typing.Optional[jsii.Number]=None) -> "WatchEcsService":
        """
        :param title: -
        :param fargate_service: -
        :param target_group: -
    ...
    def watch_scope(self, scope: aws_cdk.core.Construct, *, api_gateway: typing.Optional[bool]=None, dynamodb: typing.Optional[bool]=None, ec2ecs: typing.Optional[bool]=None, fargateecs: typing.Optional[bool]=None, lambda_: typing.Optional[bool]=None, rdsaurora: typing.Optional[bool]=None) -> None:
        """
        :param scope: -
        ...
        """
        options = WatchfulAspectProps(api_gateway=api_gateway, dynamodb=dynamodb, ec2ecs=ec2ecs, fargateecs=fargateecs, lambda_=lambda_, rdsaurora=rdsaurora)
...
class WatchfulAspect(metaclass=jsii.JSIIMeta, jsii_type="cdk-watchful.WatchfulAspect"):
    ...
    def __init__(self, watchful: "Watchful", *, api_gateway: typing.Optional[bool]=None, dynamodb: typing.Optional[bool]=None, ec2ecs: typing.Optional[bool]=None, fargateecs: typing.Optional[bool]=None, lambda_: typing.Optional[bool]=None, rdsaurora: typing.Optional[bool]=None) -> None:
        ...
        :param rdsaurora: Automatically watch RDS Aurora clusters in the scope. Default: true
        """
        props = WatchfulAspectProps(api_gateway=api_gateway, dynamodb=dynamodb, ec2ecs=ec2ecs, fargateecs=fargateecs, lambda_=lambda_, rdsaurora=rdsaurora)
...
@jsii.data_type(jsii_type="cdk-watchful.WatchfulAspectProps", jsii_struct_bases=[], name_mapping={'api_gateway': 'apiGateway', 'dynamodb': 'dynamodb', 'ec2ecs': 'ec2ecs', 'fargateecs': 'fargateecs', 'lambda_': 'lambda', 'rdsaurora': 'rdsaurora'})
class WatchfulAspectProps():
    def __init__(self, *, api_gateway: typing.Optional[bool]=None, dynamodb: typing.Optional[bool]=None, ec2ecs: typing.Optional[bool]=None, fargateecs: typing.Optional[bool]=None, lambda_: typing.Optional[bool]=None, rdsaurora: typing.Optional[bool]=None) -> None:
        """
        :param api_gateway: Automatically watch API Gateway APIs in the scope. Default: true
        :param dynamodb: Automatically watch all Amazon DynamoDB tables in the scope. Default: true
        :param ec2ecs: Automatically watch ApplicationLoadBalanced EC2 Ecs Services in the scope (using ECS Pattern). Default: true
        ...
        if ec2ecs is not None: self._values["ec2ecs"] = ec2ecs
        if fargateecs is not None: self._values["fargateecs"] = fargateecs
