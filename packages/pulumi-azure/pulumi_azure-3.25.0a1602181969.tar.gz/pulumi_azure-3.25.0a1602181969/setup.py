...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.25.0-alpha.1602181969+93df8f93'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.25.0-alpha.1602181969+93df8f93`
                """)
            else:
                raise
